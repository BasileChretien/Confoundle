...
export const ar: Record<string, string> = {
  ...
  "Mothers of babies born damaged recalled more drugs in pregnancy than their own records held. Is grief rewriting their memory?": "تذكّرت أمهات الأطفال المتضررين أدويةً في الحمل أكثر مما تحمله سجلاتهن نفسها. فهل يعيد الحزن كتابة ذاكرتهن؟",
  "Two matched groups of 203 Finnish mothers were asked after delivery which drugs they had taken in early pregnancy. Some named drugs that nothing in their pregnancy record supported.": "سُئلت مجموعتان فنلنديتان متناظرتان، تضم كل منهما 203 أمهات، بعد الولادة عن الأدوية التي تناولنها في بداية الحمل. وذكرت بعضهن أدويةً لا يدعمها شيء في سجل حملهن.",
  "What is going on here?": "ما الذي يجري هنا؟",
  "Drugs named after delivery with no earlier record": "أدوية ذُكرت بعد الولادة دون سجل سابق لها",
  "Asked in month five, before anyone knew the outcome": "سُئلن في الشهر الخامس، قبل أن يعرف أحد النتيجة",
  "Asked again after delivery, same form, same midwife": "سُئلن مجدداً بعد الولادة، بالاستمارة نفسها والقابلة نفسها",
  ...
  "The largest test of this, and it found no bias either": "أكبر اختبار لهذا، ولم يجد تحيزاً هو الآخر",
  "The United Kingdom Childhood Cancer Study compared what 1,624 case mothers and 2,524 control mothers reported against their own general-practice records. Differential recall, the effect everyone expects, was essentially absent. It is worth knowing that the bias people reach for first is often not the one present.": "قارنت دراسة سرطان الأطفال في المملكة المتحدة ما أبلغت به 1,624 أماً من الحالات و2,524 أماً من الضوابط بسجلات طبيب الأسرة الخاصة بهن. وكان التذكر التفاضلي، وهو الأثر الذي يتوقعه الجميع، غائباً في جوهره تقريباً. ومن المفيد معرفة أن التحيز الذي يلجأ إليه الناس أولاً غالباً ليس هو الحاضر فعلاً.",
  "Non-differential misclassification, a reasoning trap.": "سوء التصنيف غير التفاضلي، فخّ في الاستدلال.",
  "If a measurement is wrong in the same way for everybody, it does not create a fake result. It buries a real one. Bad measurement makes things look like they do not matter.": "إذا كان القياس مخطئاً بالطريقة نفسها للجميع، فهو لا يخلق نتيجة مزيفة، بل يدفن نتيجة حقيقية. القياس السيئ يجعل الأشياء تبدو وكأنها لا تهم.",
  "Everyone says recall bias. The real answer is worse.": "يقول الجميع إنه تحيز التذكر. أما الجواب الحقيقي فأسوأ.",
  "I confidently diagnosed recall bias. It was not recall bias.": "شخّصت الحالة بثقة على أنها تحيز التذكر، لكنه لم يكن تحيز التذكر.",
  "Every count is printed in Table 1 and reconciles three ways: the prospective rows sum to the totals the authors state in prose (34 + 43 = 77 diseases, 182 + 187 = 369 drugs), the two additional-information cells sum to 98, which Figure 1 prints separately, and 98 of the 154 positive retrospective drug replies lacking any prospective history is the approximately two thirds the authors report. Two honesty notes. The additional reports are numerically higher in the damaged-child group, 57 against 41; what the paper establishes is that the difference in the share of non-identical replies was not statistically significant on 203 mothers per group, not that the two groups were identical. And Figure 1 counts individual drug replies (420 of them) while Table 1 counts mothers (369), so the two sets of numbers are never mixed here. The reference standard for the earlier answers is the maternity welfare centre record and the mothers' own month-five interview, not an independent audit.": "كل عدد مطبوع في الجدول 1 ويتطابق بثلاث طرق: الصفوف الاستباقية تجمع إلى المجاميع التي يذكرها الباحثون نصاً (34 + 43 = 77 مرضاً، 182 + 187 = 369 دواءً)، وخليتا المعلومات الإضافية تجمعان إلى 98، وهو ما يطبعه الشكل 1 منفصلاً، و98 من أصل 154 إجابة استرجاعية إيجابية عن الأدوية دون أي سجل استباقي هي نحو الثلثين اللذين يذكرهما الباحثون. ملاحظتا أمانة: الأولى أن التقارير الإضافية أعلى عدداً في مجموعة الطفل المتضرر، 57 مقابل 41؛ وما تُثبته الورقة هو أن الفارق في نسبة الإجابات غير المتطابقة لم يكن دالاً إحصائياً على 203 أمهات لكل مجموعة، لا أن المجموعتين كانتا متطابقتين. والثانية أن الشكل 1 يحصي إجابات دوائية فردية (420 منها) بينما الجدول 1 يحصي أمهات (369)، فمجموعتا الأرقام لا تُخلطان أبداً هنا. والمعيار المرجعي للإجابات الأولى هو سجل مركز رعاية الأمومة ومقابلة الأمهات نفسها في الشهر الخامس، لا تدقيق مستقل.",
  "A large study estimates each person's salt intake from a single question about how often they add table salt, then finds almost no link between salt and blood pressure. The authors conclude that salt does not affect blood pressure.": "تُقدّر دراسة كبيرة كمية الملح التي يتناولها كل شخص من سؤال واحد عن عدد مرات إضافته ملح المائدة، ثم تجد أن الرابط بين الملح وضغط الدم يكاد ينعدم. ويستنتج الباحثون أن الملح لا يؤثر في ضغط الدم.",
  "A one-question estimate gets almost everyone's real salt intake wrong, and wrong in every direction rather than by group. Blurring the heavy and light salters together makes them look alike, which pushes any true link toward zero and can bury it.": "تقدير مبني على سؤال واحد يخطئ في تقدير تناول الملح الحقيقي لدى الجميع تقريباً، وفي كل الاتجاهات لا بحسب المجموعة. ومزج مكثري تناول الملح ومقلّيه معاً يجعلهم يبدون متشابهين، ما يدفع أي رابط حقيقي نحو الصفر وقد يدفنه.",
  "To study a factory solvent, researchers mark workers as exposed or not purely by job title, though people with the same title handle very different amounts. They find no excess disease in the exposed group and report the solvent as safe.": "لدراسة مذيب في مصنع، يُصنّف الباحثون العمال معرَّضين أو غير معرَّضين استناداً إلى المسمى الوظيفي وحده، مع أن من يحملون المسمى نفسه يتعاملون مع كميات مختلفة جداً. فلا يجدون زيادة في المرض لدى المجموعة المعرَّضة، ويُبلّغون بأن المذيب آمن.",
  "Sorting by job title puts many truly exposed workers in the unexposed column and the reverse, roughly evenly. When each compared group is a mixture of the real ones, their disease rates move together, so a genuine hazard is watered down toward no difference.": "الفرز بحسب المسمى الوظيفي يضع كثيراً من العمال المعرَّضين فعلاً في عمود غير المعرَّضين، والعكس صحيح، بالتساوي تقريباً. وحين تكون كل مجموعة مقارَنة مزيجاً من المجموعتين الحقيقيتين، تتحرك معدلات المرض فيهما معاً، فيُخفَّف خطر حقيقي نحو انعدام الفارق.",
  "A study tracks activity with a cheap clip-on counter that miscounts steps erratically for everyone, and finds no relationship between daily steps and weight change over a year. A columnist writes that step counts do not matter.": "تتبّع دراسة النشاط بعدّاد رخيص يُثبَّت بمشبك ويُخطئ في عدّ الخطوات عشوائياً لدى الجميع، فلا تجد علاقة بين عدد الخطوات اليومية وتغيّر الوزن على مدى سنة. ويكتب عمود صحفي أن عدد الخطوات لا يهم.",
  "A counter unreliable for every wearer scrambles the active and the inactive together. Noise spread evenly across the whole sample drags a correlation toward zero, so the missing relationship may be the instrument rather than the activity.": "عدّاد غير موثوق لدى كل من يرتديه يخلط النشيطين وغير النشيطين معاً. والضجيج الموزَّع بالتساوي على العينة كلها يجرّ الارتباط نحو الصفر، فقد تكون العلاقة المفقودة سببها الأداة لا النشاط.",
  "An asthma study assigns each child the average air pollution of their postcode, though levels vary sharply from street to street. The link with asthma comes out weak, and a summary says local air quality has little effect.": "تخصّص دراسة عن الربو لكل طفل متوسط تلوث الهواء في رمزه البريدي، مع أن المستويات تتفاوت بشدة من شارع إلى آخر. فيظهر الرابط مع الربو ضعيفاً، ويقول ملخص إن جودة الهواء المحلية قليلة الأثر.",
  "A postcode average is wrong for most individual children, and wrong in both directions rather than by who is ill. Measuring exposure this bluntly blends the high and low together and flattens a real gradient toward nothing.": "متوسط الرمز البريدي مخطئ بالنسبة لمعظم الأطفال فرادى، ومخطئ في كلا الاتجاهين لا بحسب من هو مريض. وقياس التعرض بهذه الفظاظة يمزج المستويات العالية والمنخفضة معاً ويُسطّح تدرجاً حقيقياً نحو العدم.",
  "Two overworked assessors grade a tissue feature from slides, making frequent slips that are just as likely for patients with the disease as for those without. The feature turns out only weakly linked to the disease, and a report calls it unimportant.": "يُقيّم مقيّمان مُرهَقان سمة نسيجية من الشرائح، فيرتكبان زلات متكررة يتساوى احتمال وقوعها لدى المرضى المصابين وغير المصابين على حد سواء. وتظهر السمة مرتبطة بالمرض ارتباطاً ضعيفاً فقط، ويصفها تقرير بأنها غير مهمة.",
  "Errors falling equally on cases and controls are non-differential. They shuffle people between feature-present and feature-absent on both sides, so the two groups look more alike than they are and a real link is dragged toward the null.": "الأخطاء التي تقع بالتساوي على الحالات والضوابط غير تفاضلية. فهي تُعيد توزيع الأشخاص بين وجود السمة وغيابها في الجانبين كليهما، فتبدو المجموعتان أكثر تشابهاً مما هما عليه، ويُجرّ رابط حقيقي نحو القيمة الصفرية.",
  "A health survey measures a habit with a confusingly worded question that people answer more or less at random. No link is found between the habit and an illness, and the survey concludes the habit is harmless.": "يقيس مسح صحي عادةً بسؤال مصاغ بطريقة مُربكة يجيب عنه الناس عشوائياً إلى حد ما. فلا يُعثر على رابط بين العادة والمرض، ويستنتج المسح أن العادة غير ضارة.",
  "A question answered almost at random splits the true doers and non-doers evenly across both answers. That equal confusion mixes the groups and pulls any genuine link toward zero, so the null describes the question, not the habit.": "سؤال يُجاب عنه عشوائياً تقريباً يوزّع من يمارسون العادة فعلاً ومن لا يمارسونها بالتساوي بين الإجابتين. وهذا الالتباس المتساوي يمزج المجموعتين ويسحب أي رابط حقيقي نحو الصفر، فالنتيجة الصفرية تصف السؤال لا العادة.",
  "A study compares two treatments using a hospital database in which the outcome is coded inconsistently, with the same sloppiness for both treatment groups. The treatments look equally effective, and the paper reports no difference.": "تقارن دراسة بين علاجين باستخدام قاعدة بيانات مستشفى تُرمَّز فيها النتيجة بتناقض، وبالإهمال نفسه في مجموعتي العلاج كلتيهما. فيبدو العلاجان متساويين في الفاعلية، وتُبلّغ الورقة بعدم وجود فارق.",
  "When the outcome is recorded just as unreliably in both arms, the errors favour neither treatment. They blur any real gap between the arms, so no difference can be the coding rather than the treatments truly being alike.": "حين تُسجَّل النتيجة بعدم موثوقية متساوية في الذراعين كلتيهما، لا تُحابي الأخطاء أي علاج. فهي تُضبّب أي فجوة حقيقية بين الذراعين، فقد يكون انعدام الفارق سببه الترميز لا أن العلاجين متماثلان فعلاً.",
  "A test for a blood marker misses about half of the true positives, at random and regardless of who is ill. Using it to classify people, a study finds the marker unrelated to the disease and drops it from further work.": "يفوت اختبار علامة دموية نحو نصف الحالات الإيجابية الحقيقية، عشوائياً وبصرف النظر عمّن هو مريض. وباستخدامه لتصنيف الأشخاص، تجد دراسة أن العلامة غير مرتبطة بالمرض وتستبعدها من العمل اللاحق.",
  "A test that mislabels exposure the same way in the sick and the well is non-differential. Filing half of the truly positive people as negative on both sides makes the two groups resemble each other, biasing the marker's apparent effect toward none.": "اختبار يُصنّف التعرض خطأً بالطريقة نفسها لدى المرضى والأصحاء غير تفاضلي. وتصنيف نصف الأشخاص الإيجابيين فعلاً على أنهم سلبيون في الجانبين كليهما يجعل المجموعتين تتشابهان، ما يُحيّز الأثر الظاهر للعلامة نحو الانعدام.",
  "Researchers measure class attendance from a sign-in sheet that students fill in haphazardly, and find attendance unrelated to exam marks. The faculty concludes that turning up makes no difference.": "يقيس الباحثون حضور الحصص من كشف توقيع يملؤه الطلاب باستهتار، فيجدون أن الحضور غير مرتبط بدرجات الامتحان. وتستنتج الكلية أن الحضور لا يُحدث فرقاً.",
  "A haphazard sheet mislabels regular and irregular attenders alike, in no particular direction. The noise is spread evenly across everyone, which mixes the groups and pushes any real effect of attending toward zero.": "كشف مُهمَل يُصنّف المواظبين وغير المواظبين خطأً على حد سواء، دون اتجاه معيّن. والضجيج موزَّع بالتساوي على الجميع، ما يمزج المجموعتين ويدفع أي أثر حقيقي للحضور نحو الصفر.",
  "A study estimates how much people sleep from one vague question and looks for a link with next-day reaction time. Everyone's estimate is off by an hour or two either way, unrelated to how they performed. No link appears, and the write-up says sleep length does not affect alertness.": "تُقدّر دراسة مقدار نوم الناس من سؤال واحد غامض، وتبحث عن رابط مع زمن رد الفعل في اليوم التالي. وتقدير كل شخص مخطئ بساعة أو ساعتين في أي من الاتجاهين، بمعزل عن أدائه. فلا يظهر رابط، ويقول التقرير إن مدة النوم لا تؤثر في اليقظة.",
  "An estimate imprecise for everyone, and untied to performance, is non-differential error. It scrambles short and long sleepers together, and mixing them like this drags a real relationship toward nothing rather than inventing one.": "تقدير غير دقيق لدى الجميع، وغير مرتبط بالأداء، هو خطأ غير تفاضلي. فهو يخلط قصار النوم وطواله معاً، ومزجهم على هذا النحو يجرّ علاقة حقيقية نحو العدم بدلاً من أن يخترع واحدة.",
  "A study measures an exposure with a method carefully validated to be accurate for nearly everyone, finds no association with the disease, and concludes the exposure probably has little effect, noting that because the measurement was reliable the null is unlikely to be hiding a large one.": "تقيس دراسة تعرضاً بطريقة مُتحقَّق منها بعناية لتكون دقيقة لدى الجميع تقريباً، فلا تجد ارتباطاً مع المرض، وتستنتج أن التعرض على الأرجح قليل الأثر، مشيرةً إلى أنه لأن القياس كان موثوقاً فمن غير المرجح أن تُخفي النتيجة الصفرية أثراً كبيراً.",
  "A null is weak evidence only when the measurement is poor. Here the exposure was measured accurately, so blurring cannot explain the missing link, and reading the null as meaningful is the sound move.": "لا تكون النتيجة الصفرية دليلاً ضعيفاً إلا حين يكون القياس سيئاً. وهنا قِيس التعرض بدقة، فلا يمكن أن يكون التضبيب تفسيراً للرابط المفقود، وقراءة النتيجة الصفرية على أنها ذات دلالة هي الخطوة السليمة.",
  "A study measured diet with a rough questionnaire and found no link to an illness. Rather than declaring the diet safe, the authors write that their crude measurement could have hidden a real effect, and call for a study with better dietary records.": "قاست دراسة النظام الغذائي باستبيان تقريبي فلم تجد رابطاً مع مرض. وبدلاً من إعلان النظام الغذائي آمناً، يكتب الباحثون أن قياسهم الخام ربما أخفى أثراً حقيقياً، ويدعون إلى دراسة بسجلات غذائية أفضل.",
  "They recognised that error spread across everyone tends to bury associations, so a null from a blunt instrument cannot prove there is nothing there. Declining to over-read it is the careful conclusion, not a trap.": "أدركوا أن الخطأ الموزَّع على الجميع يميل إلى دفن الارتباطات، فنتيجة صفرية صادرة عن أداة فظّة لا يمكن أن تُثبت أنه لا يوجد شيء. والامتناع عن قراءتها أكثر مما تحتمل هو الاستنتاج الحذر، لا فخّ.",
  "Because a single blood-pressure reading is noisy, a study averages several readings taken on separate days for every participant before testing the link with the outcome, and reports the association from those averaged values.": "لأن قراءة واحدة لضغط الدم مليئة بالضجيج، تحسب دراسة متوسط عدة قراءات أُخذت في أيام منفصلة لكل مشارك قبل اختبار الرابط مع النتيجة، وتُبلّغ عن الارتباط انطلاقاً من تلك القيم المتوسَّطة.",
  "Averaging repeated measurements cuts the random error that would otherwise blur participants together and weaken the association. Reducing non-differential error this way is exactly how to keep a real effect visible.": "حساب متوسط القياسات المتكررة يقلّل الخطأ العشوائي الذي كان سيُضبّب المشاركين معاً ويُضعف الارتباط لولا ذلك. وتقليل الخطأ غير التفاضلي على هذا النحو هو بالضبط الطريقة للحفاظ على وضوح أثر حقيقي.",
  ...
  "The tallest parents have tall children. So the tallest parents of all should have the tallest children of all, surely?": "الآباء الأطول لديهم أبناء طوال. إذن، أطول الآباء على الإطلاق ينبغي أن يكون لديهم أطول الأبناء على الإطلاق، أليس كذلك؟",
  "In 1886 Francis Galton grouped 928 grown children by their parents' height. The tallest parents averaged about 72 inches, well above the roughly 68 inch average of the day; the shortest averaged about 65. Nobody did anything to the children. They grew up and were measured.": "في عام 1886 صنّف فرانسيس غالتون 928 من الأبناء البالغين حسب طول آبائهم. بلغ متوسط طول أطول الآباء نحو 72 بوصة، وهو أعلى بكثير من متوسط ذلك العصر البالغ نحو 68 بوصة؛ وبلغ متوسط أقصر الآباء نحو 65 بوصة. لم يفعل أحد شيئاً بالأبناء؛ فقد كبروا وقِيست أطوالهم فحسب.",
  "What became of the children of these extreme-height parents?": "فماذا آل إليه أبناء هؤلاء الآباء ذوي الطول المتطرف؟",
  "Galton's 928 grown children, grouped by their parents' height": "928 من أبناء غالتون البالغين، مصنّفين حسب طول آبائهم",
  "inches": "بوصة",
  ...
  "The figures are group means computed from Galton's 928 tabulated adult children, the standard digitization of his Table I (distributed as HistData::Galton), with female heights multiplied by 1.08 exactly as Galton did. The population average was about 68.3 inches. The tallest parents, those with a mid-parent height of 71 inches or more (66 children), averaged 71.9 inches and their children 70.8; the shortest, 65.5 inches or less (103 children), averaged 65.1 and their children 66.2. These are means of the tabulated data rather than verbatim printed cell values, and they are grouped because the single one-inch bins at the extremes hold only a handful of families and are noisy. Computed across all 928 pairs, the parent-to-child regression slope is about 0.65, which reproduces Galton's own finding that a child's deviation from the mean is roughly two-thirds of the mid-parent's, the result from which the word regression descends.": "الأرقام هي متوسطات مجموعات محسوبة من 928 من أبناء غالتون البالغين المبوَّبين، وهي الرقمنة القياسية لجدوله الأول (الموزَّعة باسم الحزمة HistData::Galton)، مع ضرب أطوال الإناث في 1.08 تماماً كما فعل غالتون. بلغ متوسط عموم السكان نحو 68.3 بوصة. أما أطول الآباء، أي الذين بلغ متوسط طول الأبوين لديهم 71 بوصة أو أكثر (66 طفلاً)، فبلغ متوسط طولهم 71.9 بوصة ومتوسط أبنائهم 70.8؛ وأما أقصرهم، أي الذين بلغ متوسط طول الأبوين لديهم 65.5 بوصة أو أقل (103 أطفال)، فبلغ متوسطهم 65.1 ومتوسط أبنائهم 66.2. وهذه متوسطات للبيانات المبوَّبة لا قيم خلايا مطبوعة حرفياً، وقد جُمِّعت لأن فئات البوصة الواحدة عند الأطراف لا تضم سوى حفنة من الأسر وتكون بياناتها مشوَّشة. ومحسوباً عبر الأزواج الـ928 كلها، يبلغ ميل الانحدار من الأبوين إلى الأبناء نحو 0.65، وهو ما يعيد إنتاج ما توصل إليه غالتون نفسه من أن انحراف الطفل عن المتوسط يعادل نحو ثلثي انحراف متوسط أبويه، وهي النتيجة التي اشتُقت منها كلمة الانحدار.",
  "A council installs speed cameras at the twenty junctions with the most crashes last year. Over the next year crashes at those junctions fall, and the council reports the cameras as a clear success.": "يُركّب مجلس محلي كاميرات سرعة عند العشرين تقاطعاً الأكثر حوادث في العام الماضي. وفي العام التالي تنخفض الحوادث عند تلك التقاطعات، فيعلن المجلس أن الكاميرات نجاح واضح.",
  "The junctions were picked for an exceptionally bad year, which is partly bad luck that does not repeat. Crashes would have fallen at the worst sites anyway, so crediting the cameras needs junctions that were equally bad and left uncovered.": "اختيرت التقاطعات بسبب عام استثنائي السوء، وهو جزئياً سوء حظ لا يتكرر. وكانت الحوادث ستنخفض عند أسوأ المواقع على أي حال، لذا فإن نسبة الفضل إلى الكاميرات تحتاج إلى تقاطعات كانت سيئة بالقدر نفسه وتُركت دون تغطية.",
  "A ministry gives extra funding to the fifty lowest-scoring schools. The next year their average results rise, and the funding is declared to have worked.": "تمنح وزارة تمويلاً إضافياً للمدارس الخمسين الأدنى في النتائج. وفي العام التالي ترتفع نتائجها المتوسطة، فيُعلَن أن التمويل قد نجح.",
  "Schools land at the very bottom partly through a bad year that will not recur, so the lowest scorers tend to climb on their own. Without a comparison of equally low-scoring schools that got nothing, the rise cannot be pinned on the money.": "تصل المدارس إلى القاع جزئياً بسبب عام سيئ لن يتكرر، لذا تميل الأدنى نتيجةً إلى الارتفاع من تلقاء نفسها. وبلا مقارنة بمدارس منخفضة النتائج بالقدر نفسه ولم تحصل على شيء، لا يمكن نسبة الارتفاع إلى المال.",
  "A clinic enrols the patients with the highest cholesterol readings onto a new diet. At the recheck their readings have dropped, and the clinic recommends the diet to everyone.": "تُسجّل عيادة المرضى ذوي أعلى قراءات الكوليسترول في نظام غذائي جديد. وعند إعادة الفحص، تكون قراءاتهم قد انخفضت، فتوصي العيادة بالنظام الغذائي للجميع.",
  "People selected for the highest readings include many caught on an unusually high day, which the next test will not repeat. Their readings would fall without the diet, so only an equally high group left alone can show the diet did anything.": "يضم من اختيروا لأعلى القراءات كثيرين أُخذت قراءاتهم في يوم مرتفع بشكل غير معتاد، وهذا ما لن يتكرر في الاختبار التالي. وكانت قراءاتهم ستنخفض دون النظام الغذائي، لذا لا يمكن أن تُظهر أن النظام الغذائي فعل شيئاً إلا مجموعة مرتفعة بالقدر نفسه تُركت دون تدخل.",
  "A football club sacks its manager after the worst run of results in years. Under the caretaker the team climbs the table, and the board congratulates itself on the decision.": "يُقيل نادي كرة قدم مدربه بعد أسوأ سلسلة نتائج منذ سنوات. وتحت إشراف المدرب المؤقت، يرتقي الفريق في الترتيب، ويهنئ مجلس الإدارة نفسه على القرار.",
  "Clubs sack managers at their lowest ebb, and a lowest ebb is partly a run of bad luck that tends to end. The recovery is what a bad patch usually does next, so it is no proof the sacking helped.": "تُقيل الأندية مدربيها عند أحلك لحظاتهم، وأحلك اللحظات هي جزئياً سلسلة من سوء الحظ تميل إلى الانتهاء. والتعافي هو ما تفعله الفترة السيئة عادةً بعد ذلك، لذا فهو ليس دليلاً على أن الإقالة أفادت.",
  "People try a herbal remedy when their cold feels at its worst. Most feel much better within two days and recommend it to friends.": "يجرّب الناس علاجاً عشبياً حين يبلغ زكامهم أسوأ حالاته. ويشعر معظمهم بتحسن كبير خلال يومين ويوصون به أصدقاءهم.",
  "A cold is usually taken on at its peak, and symptoms fade from a peak on their own. Feeling better after the worst day is what a cold does, with or without the remedy.": "يُواجَه الزكام عادةً في ذروته، والأعراض تتلاشى من الذروة من تلقاء نفسها. والشعور بتحسن بعد أسوأ يوم هو ما يفعله الزكام، بالعلاج أو بدونه.",
  "An athlete voted best newcomer of the season plays less brilliantly the year after. Pundits conclude the fame went to his head.": "يُنتخَب رياضي أفضل وافد جديد في الموسم، ثم يلعب بمستوى أقل بريقاً في العام التالي. فيخلص المعلقون إلى أن الشهرة أصابت رأسه بالغرور.",
  "A best-newcomer season is a peak, and peaks are partly luck that does not hold. A more ordinary second year is what regression predicts, and it needs no story about character.": "موسم الفوز بلقب أفضل وافد جديد هو ذروة، والذّرى جزئياً حظ لا يدوم. وعام ثانٍ أكثر اعتيادية هو ما يتوقعه الانحدار نحو المتوسط، ولا يحتاج إلى أي قصة عن الشخصية.",
  "A chain sends its consultants to the ten stores with the worst sales last quarter. Those stores do better the following quarter, and the consultancy is retained.": "ترسل سلسلة متاجر استشاريها إلى المتاجر العشرة الأسوأ مبيعاً في الربع الماضي. وتحقق تلك المتاجر أداءً أفضل في الربع التالي، فيُحتفَظ بالشركة الاستشارية.",
  "The ten stores were chosen for an unusually bad quarter, which tends to be followed by a better one regardless. Judging the consultants fairly needs equally poor stores they never visited.": "اختيرت المتاجر العشرة بسبب ربع سنة سيئ بشكل غير معتاد، وهو ما يتبعه عادةً ربع أفضل بغض النظر عن أي شيء آخر. والحكم العادل على الاستشاريين يحتاج إلى متاجر ضعيفة بالقدر نفسه لم يزوروها قط.",
  "A screening drive recalls everyone whose blood pressure read highest and gives them lifestyle advice. At the recall visit their pressure is lower, and the advice is judged effective.": "تستدعي حملة فحص استقصائي كل من كانت قراءة ضغط دمه الأعلى، وتقدم لهم نصائح حول نمط الحياة. وفي زيارة الاستدعاء، يكون ضغطهم أقل، فيُحكَم بأن النصائح فعّالة.",
  "A single high reading is partly a bad moment, so the highest readers tend to read lower next time anyway. The fall is expected without any advice, and a comparison group is the only way to see the advice's own effect.": "القراءة المرتفعة المفردة هي جزئياً لحظة سيئة، لذا يميل أصحاب أعلى القراءات إلى قراءة أقل في المرة التالية على أي حال. والانخفاض متوقع بلا أي نصيحة، ومجموعة المقارنة هي السبيل الوحيد لرؤية أثر النصيحة نفسها.",
  "Drivers who collected the most penalty points in a year are required to attend a safety course. In the following year they collect far fewer points, and the course is expanded.": "يُطلَب من السائقين الذين جمعوا أكبر عدد من نقاط المخالفات في عام حضور دورة سلامة. وفي العام التالي يجمعون نقاطاً أقل بكثير، فتُوسَّع الدورة.",
  "Drivers are picked at a peak year of offences, and a peak is partly chance that eases off. Fewer points the next year is what regression predicts, so the drop does not by itself show the course worked.": "يُختار السائقون في عام ذروة من المخالفات، والذروة جزئياً صدفة تخفّ من تلقاء نفسها. ونقاط أقل في العام التالي هو ما يتوقعه الانحدار نحو المتوسط، لذا فإن الانخفاض لا يُظهر في حد ذاته أن الدورة قد أفادت.",
  "Students who scored worst on a mock exam are enrolled in a revision workshop. On the real exam they improve markedly, and the school makes the workshop compulsory for low scorers.": "يُسجَّل الطلاب الذين حصلوا على أسوأ الدرجات في امتحان تجريبي في ورشة مراجعة. وفي الامتحان الحقيقي يتحسنون بشكل ملحوظ، فتجعل المدرسة الورشة إلزامية لمنخفضي الدرجات.",
  "The worst mock scores include students who simply had an off day, who tend to do better next time regardless. Only students who scored equally badly and skipped the workshop could show whether it added anything.": "تضم أسوأ الدرجات التجريبية طلاباً مرّوا ببساطة بيوم سيئ، وهؤلاء يميلون إلى أداء أفضل في المرة التالية بغض النظر عن أي شيء. ولا يمكن أن يُظهر ما إذا كانت الورشة قد أضافت شيئاً سوى طلاب حصلوا على درجات سيئة بالقدر نفسه ولم يحضروا الورشة.",
  "A charity funds the lowest-attaining schools and evaluates the programme against an equally low-attaining set of schools, chosen the same way but left unfunded. The funded schools improved more than the unfunded ones.": "تموّل جمعية خيرية المدارس الأدنى تحصيلاً، وتقيّم البرنامج بمقارنته بمجموعة مدارس منخفضة التحصيل بالقدر نفسه، اختيرت بالطريقة نفسها لكنها تُركت دون تمويل. وتحسّنت المدارس الممولة أكثر من غير الممولة.",
  "Both sets were equally extreme, so both would drift upward by about the same amount on their own. Because the comparison schools absorb that drift, the extra improvement in the funded schools is a fair estimate of what the funding added.": "كانت المجموعتان متطرفتين بالقدر نفسه، لذا كانتا ستنجرفان صعوداً بالمقدار نفسه تقريباً من تلقاء نفسيهما. ولأن مدارس المقارنة تمتص ذلك الانجراف، فإن التحسن الإضافي في المدارس الممولة تقدير عادل لما أضافه التمويل.",
  "Patients with high blood pressure are randomly assigned to a drug or a dummy pill. Pressure falls in both groups, but it falls further on the drug, and the trial reports the difference between the two as the drug's effect.": "يُوزَّع مرضى ارتفاع ضغط الدم عشوائياً بين دواء حقيقي ودواء وهمي. وينخفض الضغط في المجموعتين، لكنه ينخفض أكثر مع الدواء الحقيقي، وتُبلغ التجربة عن الفرق بينهما بوصفه أثر الدواء.",
  "Both arms started high and both drift back toward the average, so the fall in the dummy-pill arm measures that drift. Subtracting it leaves the part that is the drug, which is exactly why the comparison arm is there.": "بدأت الذراعان مرتفعتين، وكلتاهما تنجرف عائدة نحو المتوسط، لذا فإن الانخفاض في ذراع الدواء الوهمي يقيس ذلك الانجراف. وطرحه يترك الجزء الذي هو أثر الدواء، وهذا بالضبط سبب وجود ذراع المقارنة.",
  ...
  "A gene variant carried by millions goes with about 2.5 times the odds of esophageal cancer, and adjusting for alcohol barely changes it. A modest risk gene, then?": "متغير جيني يحمله ملايين الأشخاص يرتبط بنحو 2.5 ضعف أرجحية الإصابة بسرطان المريء، والتعديل الإحصائي للكحول بالكاد يغيّر ذلك. فهل هو إذن جين خطر متواضع؟",
  "In South Korean men, researchers compared the ALDH2 gene variant between esophageal cancer patients and healthy controls. Carriers had roughly 2.5 times the odds of cancer, and adjusting for whether the men drank alcohol left that almost unchanged, which usually means a factor is standing on its own.": "في رجال كوريين جنوبيين، قارن باحثون المتغير الجيني ALDH2 بين مرضى سرطان المريء والشواهد الأصحاء. كان لدى حاملي المتغير نحو 2.5 ضعف أرجحية الإصابة بالسرطان، والتعديل الإحصائي لما إذا كان الرجال يشربون الكحول ترك ذلك شبه ثابت، وهو ما يعني عادةً أن عاملاً ما يقف قائماً بذاته.",
  "What is the gene really doing?": "ما الذي يفعله الجين حقاً؟",
  "The ALDH2 variant and esophageal cancer in Korean men": "المتغير ALDH2 وسرطان المريء لدى الرجال الكوريين",
  "Odds of esophageal cancer with the variant": "أرجحية الإصابة بسرطان المريء مع المتغير",
  ...
  "about 2.5 times the odds, with or without drinking": "نحو 2.5 ضعف الأرجحية، بوجود شرب الكحول أو غيابه",
  ...
  "The four cells of each stratum are read from Table 3, men's panel. Among current drinkers, 219 of 640 variant carriers were cancer patients against 211 of 1,993 non-carriers; among non-drinkers, 198 of 916 carriers against 123 of 679 non-carriers. The stratum odds ratios reproduce the paper's printed 4.39 and 1.25 exactly, the pooled cells give a crude 2.56, and the Mantel-Haenszel adjustment gives 2.44, consistent with the paper's finding that the association differs by drinking (interaction P < 0.001). Two honesty notes. The men's panel is used because the women's odds ratios in the same table are age-adjusted and do not reconcile from the raw cells. And the exposure is framed as the paper frames it, the genotype, with drinking as the modifier; framing alcohol as the exposure on these same cells would give a misleading apparently protective odds ratio, an artefact of non-drinkers who abstain because of ill health and of not adjusting for tobacco.": "الخلايا الأربع لكل شريحة مأخوذة من الجدول 3، لوحة الرجال. فبين الشاربين الحاليين، كان 219 من أصل 640 من حاملي المتغير مرضى سرطان مقابل 211 من أصل 1,993 من غير الحاملين؛ وبين غير الشاربين، كان 198 من أصل 916 من الحاملين مقابل 123 من أصل 679 من غير الحاملين. تعيد نسب الأرجحية الخاصة بكل شريحة إنتاج الرقمين 4.39 و1.25 المطبوعين في البحث بالضبط، وتعطي الخلايا المجمَّعة نسبة خام قدرها 2.56، ويعطي تعديل مانتل-هينزل 2.44، وهو ما يتسق مع ما وجده البحث من أن الارتباط يختلف باختلاف شرب الكحول (تفاعل P < 0.001). وهاتان ملاحظتا نزاهة. تُستخدم لوحة الرجال لأن نسب الأرجحية لدى النساء في الجدول نفسه معدَّلة حسب العمر ولا تتوافق مع الخلايا الخام. كما أن التعرض يُصاغ كما يصوغه البحث، أي النمط الجيني، مع شرب الكحول بوصفه المعدِّل؛ ولو صيغ الكحول بوصفه التعرض على هذه الخلايا نفسها، لأعطى نسبة أرجحية مضللة تبدو واقية، وهي أثر مصطنع ناتج عن غير الشاربين الذين يمتنعون بسبب اعتلال صحي وعن عدم التعديل الإحصائي للتبغ.",
  "A study reports that regular sunscreen use cuts skin cancer risk by about a fifth on average, adjusting for skin type. The benefit is large in fair-skinned people and negligible in the darkest-skinned. The health message quotes only the one-fifth figure.": "تُبلغ دراسة بأن الاستخدام المنتظم لواقي الشمس يقلل من خطر سرطان الجلد بنحو الخُمس في المتوسط، بعد التعديل الإحصائي لنوع البشرة. وتكون الفائدة كبيرة لدى ذوي البشرة الفاتحة وضئيلة لدى الأشد سُمرة. وتقتبس الرسالة الصحية رقم الخُمس فقط.",
  "The effect genuinely differs by skin type, so a single averaged number describes neither group. Skin type here is not a nuisance to adjust away but the thing that decides how much sunscreen helps, and it should be reported separately.": "الأثر يختلف فعلاً باختلاف نوع البشرة، لذا فإن رقماً واحداً مأخوذاً كمتوسط لا يصف أياً من المجموعتين. ونوع البشرة هنا ليس إزعاجاً يُزال بالتعديل الإحصائي، بل هو ما يحدد مقدار فائدة واقي الشمس، وينبغي الإبلاغ عنه بشكل منفصل.",
  "A blood pressure drug is licensed with the claim that it lowers pressure by 8 mmHg. Split by age, it barely moves pressure under 50 and lowers it markedly over 70. Only the single average appears on the label.": "يُرخَّص دواء لضغط الدم بدعوى أنه يخفض الضغط بمقدار 8 ملم زئبقي. وعند التقسيم حسب العمر، بالكاد يحرك الضغط دون سن 50 ويخفضه خفضاً ملحوظاً بعد سن 70. ولا يظهر على الملصق سوى المتوسط الواحد.",
  "Age changes the size of the effect, so the 8 mmHg is an average that fits no age group well. When an effect differs across subgroups it should be reported by subgroup, not collapsed into one figure.": "العمر يغيّر حجم الأثر، لذا فإن الـ 8 ملم زئبقي هو متوسط لا يناسب أي فئة عمرية جيداً. وحين يختلف الأثر بين المجموعات الفرعية، ينبغي الإبلاغ عنه حسب المجموعة الفرعية، لا اختزاله في رقم واحد.",
  "A painkiller relieves pain strongly in people with one liver-enzyme genotype and hardly at all in those with another. A review pools every patient and reports a modest average benefit.": "مسكّن للألم يخفف الألم بقوة لدى من لديهم نمط جيني معين لأحد إنزيمات الكبد، وبالكاد يخففه لدى من لديهم نمط آخر. وتجمع مراجعة كل المرضى معاً وتُبلغ عن فائدة متوسطة متواضعة.",
  "The genotype decides whether the drug works, so pooling produces a number that overstates it for one group and invents it for the other. The genotype is the finding, not a variable to average over.": "النمط الجيني هو ما يحدد ما إذا كان الدواء ينفع أم لا، لذا فإن التجميع ينتج رقماً يبالغ في تقديره لمجموعة ويختلقه لمجموعة أخرى. فالنمط الجيني هو النتيجة نفسها، لا متغيراً يُؤخذ متوسطه.",
  "Researchers find a treatment helps men and harms women by about the same amount. To account for sex, they adjust for it and report a single near-zero effect, concluding the treatment does nothing.": "يجد باحثون أن علاجاً ينفع الرجال ويضر النساء بالمقدار نفسه تقريباً. ولمراعاة الجنس، يعدّلون إحصائياً لأجله ويُبلغون عن أثر واحد قريب من الصفر، فيخلصون إلى أن العلاج لا يفعل شيئاً.",
  "Adjusting for sex has buried two real and opposite effects under an average of nearly zero. Sex is modifying the effect, not confounding it, so the honest report is the two subgroups apart, not one number that hides both.": "التعديل الإحصائي للجنس دفن أثرين حقيقيين ومتعاكسين تحت متوسط يقارب الصفر. فالجنس هنا يعدِّل الأثر، لا يخلطه، لذا فإن التقرير النزيه هو المجموعتان الفرعيتان منفصلتين، لا رقم واحد يخفي كليهما.",
  "A fertiliser trial across many fields finds it raises yield on sandy soil and does nothing on clay. The report gives the average increase and recommends the fertiliser for all fields.": "تجربة لسماد عبر حقول عديدة تجد أنه يرفع المحصول في التربة الرملية ولا يفعل شيئاً في التربة الطينية. ويعطي التقرير متوسط الزيادة ويوصي بالسماد لكل الحقول.",
  "Soil type changes whether the fertiliser works at all, so an average across soils recommends it where it is useless. The effect should be reported by soil, which is the practical answer a farmer needs.": "نوع التربة يغيّر ما إذا كان السماد ينفع أصلاً أم لا، لذا فإن متوسطاً عبر أنواع التربة يوصي به حيث لا فائدة منه. وينبغي الإبلاغ عن الأثر حسب نوع التربة، وهو الجواب العملي الذي يحتاجه المزارع.",
  "A vaccine is highly protective in younger adults and only weakly protective in the elderly. A briefing note gives a single overall efficacy figure for the whole population.": "لقاح واقٍ بدرجة عالية لدى البالغين الأصغر سناً وواقٍ بدرجة ضعيفة فقط لدى كبار السن. وتعطي مذكرة إحاطة رقماً واحداً لفعاليته الإجمالية عبر السكان كلهم.",
  "Age modifies how well the vaccine works, so one figure overstates the protection the elderly can expect. A modifier like this belongs in the results split out, because the subgroups need different advice.": "العمر يعدِّل مدى نجاعة اللقاح، لذا فإن رقماً واحداً يبالغ في تقدير الحماية التي يمكن أن يتوقعها كبار السن. ومعدِّل كهذا مكانه أن يُفصل في النتائج، لأن المجموعات الفرعية تحتاج إلى نصائح مختلفة.",
  "A tutoring programme raises test scores sharply for pupils who started behind and not at all for those already ahead. The evaluation reports one average gain and rolls the programme out to everyone.": "برنامج تقوية يرفع درجات الاختبارات ارتفاعاً حاداً لدى التلاميذ الذين بدأوا متأخرين ولا يرفعها إطلاقاً لدى من كانوا متقدمين أصلاً. ويُبلغ التقييم عن مكسب متوسط واحد ويعمم البرنامج على الجميع.",
  "Starting level decides who benefits, so an average gain misdescribes both the pupils it helps and those it does not. This is an effect that differs by subgroup, to be reported by subgroup rather than averaged.": "مستوى البداية هو ما يحدد من يستفيد، لذا فإن متوسط المكسب يصف وصفاً خاطئاً كلاً من التلاميذ الذين يفيدهم البرنامج ومن لا يفيدهم. وهذا أثر يختلف حسب المجموعة الفرعية، وينبغي الإبلاغ عنه حسب المجموعة الفرعية لا أخذ متوسطه.",
  "An occupational study finds a workplace solvent raises lung cancer risk steeply in smokers and not detectably in non-smokers. The authors adjust for smoking and present a single modest risk for the solvent.": "دراسة مهنية تجد أن مذيباً في مكان العمل يرفع خطر سرطان الرئة ارتفاعاً حاداً لدى المدخنين ولا يرفعه بشكل يمكن كشفه لدى غير المدخنين. ويعدّل المؤلفون إحصائياً للتدخين ويعرضون خطراً متواضعاً واحداً للمذيب.",
  "Smoking is not just a confounder here, it decides whether the solvent does harm, so adjusting it into one number hides that the danger is concentrated in smokers. The two groups should be reported separately.": "التدخين هنا ليس مجرد عامل مربِك، بل هو ما يحدد ما إذا كان المذيب يسبب ضرراً أم لا، لذا فإن حصره في رقم واحد بالتعديل الإحصائي يخفي أن الخطر يتركز لدى المدخنين. وينبغي الإبلاغ عن المجموعتين بشكل منفصل.",
  "A dietary change lowers heart attacks in people with diabetes and has no effect in people without it. A meta-analysis pools all participants and concludes the diet has a small, marginal benefit.": "تغيير غذائي يقلل النوبات القلبية لدى المصابين بالسكري ولا يترك أثراً لدى غير المصابين به. ويجمع تحليل تلوي كل المشاركين ويخلص إلى أن الحمية لها فائدة صغيرة وهامشية.",
  "The diet's effect depends on diabetes status, so pooling dilutes a real benefit for one group into a marginal-looking average for everyone. Diabetes is the modifier, and the strata carry the real message.": "أثر الحمية يتوقف على حالة الإصابة بالسكري، لذا فإن التجميع يخفف فائدة حقيقية لمجموعة واحدة إلى متوسط يبدو هامشياً بالنسبة إلى الجميع. فالسكري هو المعدِّل، والشرائح هي التي تحمل الرسالة الحقيقية.",
  "A feature raises spending a lot among brand-new users and not at all among long-standing ones. The product team reports the average uplift across all users and ships the feature to everybody.": "ميزة ترفع الإنفاق كثيراً بين المستخدمين الجدد تماماً ولا ترفعه إطلاقاً بين المستخدمين القدامى. ويُبلغ فريق المنتج عن متوسط الارتفاع عبر كل المستخدمين ويطلق الميزة للجميع.",
  "How long someone has used the product decides whether the feature does anything, so the average uplift misleads about both groups. When an effect differs by subgroup, the subgroups are the result, not a detail to average over.": "مدة استخدام الشخص للمنتج هي ما يحدد ما إذا كانت الميزة تفعل شيئاً أم لا، لذا فإن متوسط الارتفاع يضلل بشأن كلتا المجموعتين. حين يختلف الأثر حسب المجموعة الفرعية، تكون المجموعات الفرعية هي النتيجة، لا تفصيلاً يُؤخذ متوسطه.",
  "Coffee drinkers have more heart disease, but they also smoke more. After adjusting for smoking the association disappears, and the same near-zero link holds within smokers and within non-smokers alike. The authors report that coffee is not associated once smoking is accounted for.": "يعاني شاربو القهوة من أمراض قلبية أكثر، لكنهم يدخنون أكثر أيضاً. وبعد التعديل الإحصائي للتدخين، يختفي الارتباط، ويثبت الرابط نفسه القريب من الصفر داخل مجموعة المدخنين وداخل مجموعة غير المدخنين على حد سواء. ويُبلغ المؤلفون بأن القهوة لا ترتبط بالمرض متى أُخذ التدخين في الحسبان.",
  "Because the link is the same small thing in both smoking groups, smoking was a genuine confounder and adjusting for it is the right move. A single adjusted number is a fair summary precisely because the strata agree.": "لأن الرابط هو الشيء الصغير نفسه في مجموعتَي التدخين كلتيهما، كان التدخين عاملاً مربِكاً حقيقياً، والتعديل الإحصائي له هو التصرف الصحيح. والرقم المعدَّل الواحد ملخص عادل، وذلك تحديداً لأن الشرائح متفقة.",
  "A trial finds a drug clearly helps patients with a particular marker and does nothing for those without it. Rather than quoting one overall effect, the report gives the two groups separately and recommends the drug only for the marker-positive patients.": "تجد تجربة سريرية أن دواءً ينفع بوضوح المرضى الذين لديهم مؤشر معين ولا يفعل شيئاً لمن لا يحملونه. وبدلاً من ذكر أثر إجمالي واحد، يعطي التقرير المجموعتين منفصلتين ويوصي بالدواء فقط للمرضى الإيجابيين لذلك المؤشر.",
  "When an effect differs by subgroup, reporting the subgroups apart is exactly right, and pooling them into one average would have been the error. Prespecifying the marker and acting on it is careful practice, not a trap.": "حين يختلف الأثر حسب المجموعة الفرعية، فإن الإبلاغ عن المجموعات الفرعية منفصلة هو الصواب بعينه، وكان تجميعها في متوسط واحد سيكون هو الخطأ. وتحديد المؤشر مسبقاً والعمل بموجبه ممارسة حريصة، لا فخاً.",
  "As one number": "كرقم واحد",
  "Split by the third factor": "حسب العامل الثالث",

  // ---- Detection (observer) bias puzzle + review items ----
  "Give surgical patients far less IV fluid and complications seem to plummet. A clear win for less fluid?": "أعطِ مرضى الجراحة سوائل وريدية أقل بكثير، ويبدو أن المضاعفات تنخفض انخفاضًا حادًا. أهو انتصار واضح لتقليل السوائل؟",
  "In a trial, an assessor recorded which patients had a postoperative complication. In the restrictive-fluid group 31 percent did, against 55 percent on the standard regimen, and the difference was highly significant (P = 0.002).": "في تجربة سريرية، سجّل مقيّم أي المرضى أُصيبوا بمضاعفة بعد الجراحة. ففي مجموعة السوائل التقييدية أُصيب 31% منهم، مقابل 55% في مجموعة النظام المعياري، وكان الفرق ذا دلالة إحصائية عالية (P = 0.002).",
  "How much should you trust the size of that benefit?": "إلى أي حد ينبغي أن تثق بحجم تلك الفائدة؟",
  "Had a postoperative complication": "أُصيب بمضاعفة بعد الجراحة",
  "Restrictive fluid": "سوائل تقييدية",
  "Restrictive": "تقييدي",
  "Standard fluid": "سوائل معيارية",
  "Standard": "معياري",
  "Graded by an assessor who knew the regimen": "قيّمه مقيّم كان يعرف النظام العلاجي",
  "Graded by an assessor kept unaware": "قيّمه مقيّم أُبقي غير عالم بالنظام العلاجي",
  ...
  "The groups must have differed to begin with": "لا بد أن المجموعتين اختلفتا منذ البداية",
  ...
  "Grade the same patients blind, and the gap narrows.": "قيّم المرضى أنفسهم بطريقة عمياء، فيضيق الفارق.",
  "What the grader knew": "ما كان يعرفه المقيّم",
  "The same 172 patients, judged again by an assessor kept unaware of who got which regimen: 28 of 86 with a complication on restrictive fluid (33 percent) against 44 of 86 on standard (51 percent). Restrictive fluid still helped, but the gap is 18 points rather than the 24 the unblinded grader recorded, and the p-value slips from 0.002 to 0.013.": "المرضى الـ172 أنفسهم، قيّمهم مجددًا مقيّم أُبقي غير عالم بمن تلقى أي نظام: 28 من 86 أُصيبوا بمضاعفة مع السوائل التقييدية (33%) مقابل 44 من 86 مع السوائل المعيارية (51%). السوائل التقييدية ما زالت مفيدة، لكن الفارق أصبح 18 نقطة بدلًا من الـ24 التي سجّلها المقيّم غير الأعمى، وتنزلق قيمة p من 0.002 إلى 0.013.",
  "Unblinded, then blinded": "غير أعمى، ثم أعمى",
  "The randomisation was fine and the groups were comparable. What changed is who held the pen. When the person deciding whether an ambiguous case counts as a complication knows which arm the patient was in, the borderline calls drift toward the expected answer. That drift did not invent the benefit, restrictive fluid genuinely did better, but it stretched it and made it look more certain than the blinded record supports.": "كان التوزيع العشوائي سليمًا والمجموعتان قابلتين للمقارنة. ما تغيّر هو من كان يمسك القلم. فحين يعرف الشخص الذي يقرر ما إذا كانت حالة غامضة تُحتسب مضاعفة أم لا أي ذراع كان المريض فيها، تنجرف الأحكام الحدّية نحو الإجابة المتوقَّعة. ذلك الانجراف لم يخترع الفائدة، فالسوائل التقييدية كانت أفضل فعلًا، لكنه ضخّمها وجعلها تبدو أكثر يقينًا مما يدعمه السجل الأعمى.",
  "Blinded against not": "أعمى في مقابل غير أعمى",
  "Detection bias": "تحيّز الكشف",
  "When whoever judges the outcome knows who got the treatment, their judgement drifts toward the expected result. It rarely conjures an effect from nothing; it exaggerates a real one and lends it false certainty. The defence is to blind the assessor, which is separate from blinding patients and clinicians.": "حين يعرف من يحكم على النتيجة من تلقى العلاج، ينجرف حكمه نحو النتيجة المتوقَّعة. ونادرًا ما يستحضر أثرًا من العدم؛ بل يضخّم أثرًا حقيقيًا ويمنحه يقينًا زائفًا. والوقاية من ذلك تكمن في تعمية المقيّم، وهو أمر منفصل عن تعمية المرضى والأطباء.",
  "Detection bias bites hardest on outcomes that take judgement: a wound called infected or not, a scan read as progression or not, a symptom scored on a scale. It barely touches a hard endpoint like death, taken from a registry. So the question to ask of an impressive result is not only whether the patients were blinded, but whether the person recording the outcome was.": "يضرب تحيّز الكشف بأقسى قوة في النتائج التي تحتاج إلى حكم: جرح يُقال إنه مصاب بعدوى أو لا، فحص تصويري يُقرأ على أنه تطوّر للمرض أو لا، عرَض يُقاس على مقياس. وهو بالكاد يمس نقطة نهاية صلبة كالوفاة، مأخوذة من سجل رسمي. لذا فالسؤال الذي ينبغي طرحه عن نتيجة مبهرة ليس فقط هل كان المرضى معمَّين، بل هل كان الشخص الذي سجّل النتيجة معمًّى أيضًا.",
  "Blinding is not one thing. Patients can be blinded so their own reports are not swayed by knowing they got the real treatment; clinicians can be blinded so the care they give does not differ; and the outcome assessor can be blinded so their reading of who improved is not coloured by which arm they are grading. A trial can manage the first two and still leak bias through the third, because most outcomes worth measuring need a human to interpret them. That is why assessor-blinding is its own line in a methods section, and why an open-label trial with a subjective endpoint should have the size of its effect discounted, not just its direction doubted.": "التعمية ليست شيئًا واحدًا. فيمكن تعمية المرضى حتى لا تتأثر إفاداتهم بمعرفتهم أنهم تلقوا العلاج الحقيقي؛ ويمكن تعمية الأطباء حتى لا تختلف الرعاية التي يقدمونها؛ ويمكن تعمية مقيّم النتيجة حتى لا تتلوّن قراءته لمن تحسّن بمعرفة الذراع التي يقيّمها. وقد تُحكم تجربة الأمرين الأولين وما زال التحيّز يتسرب عبر الثالث، لأن معظم النتائج الجديرة بالقياس تحتاج إنسانًا يفسرها. لهذا فإن تعمية المقيّم بند قائم بذاته في قسم المنهجية، ولهذا ينبغي لتجربة مفتوحة التصنيف ذات نقطة نهاية ذاتية أن يُخصم من حجم أثرها، لا أن يُشكَّك في اتجاهه فقط.",
  "Not one unlucky trial": "ليست تجربة واحدة سيئة الحظ",
  "A review paired blinded and non-blinded judgements of the same yes-or-no outcome across 21 trials and 4,391 patients. On average the non-blinded assessors exaggerated the odds ratio by 36 percent (ratio of odds ratios 0.64, 95 percent confidence interval 0.43 to 0.96). The fluid trial here was one of the 21.": "قارنت مراجعة منهجية بين أحكام عمياء وأحكام غير عمياء على النتيجة نفسها من نوع نعم أو لا، عبر 21 تجربة و4,391 مريضًا. وفي المتوسط، بالغ المقيّمون غير المعمَّين في تقدير نسبة الأرجحية بمقدار 36% (نسبة نسبتي الأرجحية 0.64، بفاصل ثقة 95% يتراوح من 0.43 إلى 0.96). وكانت تجربة السوائل هذه إحدى التجارب الـ21.",
  "Detection bias, a reasoning trap.": "تحيّز الكشف، فخ في الاستدلال.",
  "When the person scoring the result knows who got the treatment, the borderline calls slide toward the hoped-for answer. Grade the same patients blind and the effect shrinks and loses certainty. It rarely conjures a result from nothing, but it inflates one. Before believing the size of a benefit, ask who measured the outcome, and whether they knew which group they were looking at.": "حين يعرف من يُقيّم النتيجة مَن تلقى العلاج، تنزلق الأحكام الحدّية نحو الإجابة المرجوّة. وإذا قُيّم المرضى أنفسهم بطريقة عمياء، يتقلّص الأثر ويفقد يقينه. ونادرًا ما يستحضر نتيجة من العدم، لكنه يضخّم نتيجة قائمة. وقبل تصديق حجم أي فائدة، اسأل من قاس النتيجة، وهل كان يعرف أي مجموعة كان ينظر إليها.",
  "Everyone trusts the number. Fewer ask who measured it.": "الجميع يثقون بالرقم. قلة يسألون من قاسه.",
  "I trusted the number. Nobody had blinded the grader.": "وثقت بالرقم. لم يُعمِّ أحد المقيّم.",
  "In an open trial of a new dressing, the surgeon who chose which patients got it also reviewed their wound photos and decided which counted as infected. The new dressing came out with far fewer infections.": "في تجربة مفتوحة لضمادة جديدة، كان الجرّاح الذي اختار أي المرضى يحصل عليها هو نفسه من راجع صور جروحهم وقرر أيها يُحتسب مصابًا بعدوى. وظهرت الضمادة الجديدة بعدد أقل بكثير من حالات العدوى.",
  "Whether a borderline wound is called infected is a judgement, and the person making it knew which dressing each patient had. Have someone blinded to the dressing grade the same photos before believing the size of the gap.": "تسمية جرح حدّي بأنه مصاب بعدوى حكم شخصي، والشخص الذي أصدره كان يعرف أي ضمادة استخدمها كل مريض. فاجعل شخصًا معمًّى عن نوع الضمادة يقيّم الصور نفسها قبل أن تصدق حجم الفارق.",
  "A physiotherapist testing her own new programme also scored each patient's mobility at the end. Her scores showed the new programme clearly beating usual care.": "اختبرت أخصائية علاج طبيعي برنامجها الجديد الخاص، وهي نفسها من قيّمت حركة كل مريض في النهاية. وأظهرت تقييماتها أن البرنامج الجديد يتفوق بوضوح على الرعاية المعتادة.",
  "The person hoping the programme works is the one rating the outcome, so ambiguous movements get scored generously for her group. A blinded assessor rating the same patients is what would settle it.": "الشخص الذي يتمنى نجاح البرنامج هو نفسه من يقيّم النتيجة، فتُمنح الحركات الغامضة درجات سخية لمجموعتها. ومقيّم أعمى يقيّم المرضى أنفسهم هو ما قد يحسم الأمر.",
  "A radiologist was told which patients were on the new cancer drug before reading their follow-up scans. He marked the drug group as 'stable or improved' far more often than the comparison group.": "أُخبر أخصائي أشعة بأي المرضى يتلقون دواء السرطان الجديد قبل قراءة فحوصاتهم التصويرية اللاحقة. وصنّف مجموعة الدواء بأنها 'مستقرة أو متحسّنة' بمعدل أعلى بكثير من مجموعة المقارنة.",
  "Reading a scan as progression or not takes interpretation, and knowing the arm tilts the close calls. Scans read blind, in a random order, are the only version worth trusting.": "قراءة فحص تصويري على أنه تطوّر للمرض أو لا يحتاج إلى تفسير، ومعرفة الذراع تُميل الأحكام المتقاربة. والقراءة العمياء للفحوصات، بترتيب عشوائي، هي النسخة الوحيدة الجديرة بالثقة.",
  "A teacher graded her pupils' essays knowing which of them had used a new writing app she had championed. The app users scored noticeably higher, and she reported the app as a success.": "قيّمت معلمة مقالات تلاميذها وهي تعرف أيهم استخدم تطبيق كتابة جديدًا كانت قد تبنّته. وحصل مستخدمو التطبيق على درجات أعلى بشكل ملحوظ، فأبلغت أن التطبيق نجح.",
  "Essay marks are a judgement, and the grader both knew the groups and wanted the app to work. Marking the essays blind, with names and app-use hidden, is what would show whether the gap is real.": "درجات المقالات حكم شخصي، والمقيّمة كانت تعرف المجموعتين وتريد للتطبيق أن ينجح. وتقييم المقالات بطريقة عمياء، مع إخفاء الأسماء واستخدام التطبيق، هو ما قد يُظهر إن كان الفارق حقيقيًا.",
  "At a gymnastics meet the judges could see which athletes came from a famous academy. Those athletes received higher marks for routines that, on video review by judges who could not tell where they trained, scored about the same as everyone else's.": "في بطولة جمباز، كان بإمكان الحكام رؤية أي الرياضيين ينتمون إلى أكاديمية مشهورة. فحصل هؤلاء الرياضيون على درجات أعلى لتمارين حصلت، عندما راجعها بالفيديو حكام لا يعرفون أين تدرب أصحابها، على درجات مماثلة تقريبًا لدرجات البقية.",
  "Scoring a routine is a judgement call, and knowing the prestigious academy nudged it upward. The blinded video review of the same routines is the unbiased measurement.": "تقييم تمرين حكم شخصي، ومعرفة الأكاديمية المرموقة دفعته إلى الأعلى. ومراجعة الفيديو العمياء للتمارين نفسها هي القياس غير المتحيّز.",
  "A vet assessing whether horses were still lame knew which ones had been given a new joint supplement. She rated the supplement group as sounder, and the makers advertised the result.": "كانت طبيبة بيطرية تُقيّم ما إذا كانت الخيول ما تزال تعرج تعرف أيها تلقى مكمّلًا جديدًا للمفاصل. وقيّمت مجموعة المكمّل بأنها أسلم، وأعلنت الشركة المصنّعة عن النتيجة.",
  "Grading lameness is a judgement, and the assessor knew which horses were supposed to improve. A vet blinded to which horses got the supplement, watching the same gaits, is what the claim needs.": "تقييم العرج حكم شخصي، وكانت المقيّمة تعرف أي الخيول يُفترض أن تتحسّن. وطبيبة بيطرية معمّاة عن أي الخيول تلقت المكمّل، تشاهد المشي نفسه، هي ما يحتاجه هذا الادعاء.",
  "A researcher read patients' free-text symptom diaries and coded each week as better or worse, with the treatment arm visible at the top of every page. Ambiguous weeks were coded 'better' more often for the treated patients.": "قرأ باحث مذكرات أعراض حرة الصياغة كتبها المرضى، ورمّز كل أسبوع بأنه أفضل أو أسوأ، وكانت الذراع العلاجية ظاهرة أعلى كل صفحة. ورُمّزت الأسابيع الغامضة بأنها 'أفضل' في أحيان أكثر لدى المرضى المعالَجين.",
  "Turning a vague diary entry into better-or-worse is interpretation, and the arm label steered the doubtful ones. Coding the diaries with the arm hidden removes the tilt.": "تحويل مدخل مذكرات غامض إلى أفضل أو أسوأ تفسير، وقد وجّه ظهور اسم الذراع الحالات المشكوك فيها. وترميز المذكرات مع إخفاء الذراع يزيل هذا الميل.",
  "Observers scored children's classroom behaviour for a study of a new diet. They were told which children were on the diet, and recorded fewer disruptive episodes for that group.": "قيّم مراقبون سلوك الأطفال داخل الصف الدراسي لدراسة عن حمية غذائية جديدة. وأُخبروا بأي الأطفال يتّبعون الحمية، فسجّلوا عدد نوبات إخلال أقل لتلك المجموعة.",
  "Whether a fidget counts as a disruptive episode is a judgement, and knowing who was on the diet shaded it. Observers blinded to the diet, scoring the same footage, are what a real test requires.": "احتساب حركة تململ نوبة إخلال بالنظام حكم شخصي، ومعرفة من يتّبع الحمية لوّنت هذا الحكم. ومراقبون معمَّون عن الحمية، يقيّمون التسجيلات نفسها، هم ما يتطلبه اختبار حقيقي.",
  "An endoscopist assessing whether ulcers had healed could see, on each patient's chart, which drug they had received. He judged more ulcers 'healed' in the new-drug group.": "كان أخصائي مناظير يُقيّم ما إذا كانت القروح قد التأمت يستطيع أن يرى، في ملف كل مريض، أي دواء تلقى. وحكم بأن عدد قروح أكبر قد 'التأم' في مجموعة الدواء الجديد.",
  "Calling an ulcer healed or not is an interpretation, and the visible drug name nudged the borderline ones. The images should be read by someone who cannot tell which drug the patient took.": "تسمية قرحة بأنها التأمت أو لا تفسير، واسم الدواء الظاهر دفع الحالات الحدّية. وينبغي أن تُقرأ الصور من قبل شخص لا يمكنه معرفة أي دواء تناوله المريض.",
  "A dermatologist rated the severity of patients' rashes on a ten-point scale, aware of which cream each had been given. The trial cream's patients were scored two points milder on average.": "قيّم طبيب جلدية شدة طفح المرضى على مقياس من عشر درجات، وهو يعلم أي كريم أُعطي لكل منهم. وحصل مرضى كريم التجربة على درجات أخف بمقدار نقطتين في المتوسط.",
  "A severity score is a judgement, and knowing the cream drew the ratings toward the hoped-for answer. A rater blinded to the cream, scoring the same rashes, is what would show the true difference.": "درجة الشدة حكم شخصي، ومعرفة الكريم جذبت التقييمات نحو الإجابة المرجوّة. ومقيّم معمًّى عن الكريم، يقيّم الطفح نفسه، هو ما قد يُظهر الفارق الحقيقي.",
  "In a heart-drug trial, every suspected heart attack was judged by an independent committee working from anonymised records that never revealed which drug the patient had taken. The drug group had fewer confirmed heart attacks.": "في تجربة لدواء قلبي، حكمت لجنة مستقلة على كل حالة نوبة قلبية مشتبه بها استنادًا إلى سجلات مجهولة الهوية لم تكشف قط أي دواء تناوله المريض. وسجّلت مجموعة الدواء عددًا أقل من النوبات القلبية المؤكدة.",
  "The people deciding the outcome could not tell the groups apart, so their judgement cannot have been swayed by expectation. This is exactly how a subjective outcome should be assessed.": "لم يكن بإمكان من يقررون النتيجة التمييز بين المجموعتين، فلا يمكن أن يكون حكمهم قد تأثر بالتوقّع. وهذه بالضبط الطريقة التي ينبغي أن تُقيَّم بها نتيجة ذاتية.",
  "An open-label trial could not blind patients or doctors, but its only outcome was death from any cause, taken from the national death registry. The treated group had fewer deaths.": "لم تستطع تجربة مفتوحة التصنيف تعمية المرضى أو الأطباء، لكن نتيجتها الوحيدة كانت الوفاة لأي سبب، مأخوذة من السجل الوطني للوفيات. وسجّلت المجموعة المعالَجة عدد وفيات أقل.",
  "Death recorded by a registry needs no interpretation, so it does not matter that everyone knew the assignment. For a hard endpoint like this, an unblinded assessor cannot bend the result.": "الوفاة المسجّلة في سجل رسمي لا تحتاج إلى تفسير، لذا لا يهم أن يكون الجميع قد عرف التوزيع. ولنقطة نهاية صلبة كهذه، لا يمكن لمقيّم غير أعمى أن يحرّف النتيجة.",
  "A blood-pressure study used a validated monitor that recorded each reading and uploaded it automatically, with no clinician deciding or transcribing the number, even though staff knew who was on the drug.": "استخدمت دراسة عن ضغط الدم جهاز قياس معتمَدًا سجّل كل قراءة ورفعها تلقائيًا، من دون أن يقرر أي طبيب الرقم أو ينسخه، رغم أن الطاقم كان يعرف من يتلقى الدواء.",
  "No human judged the outcome, so knowing the group could not colour it. Automating the measurement removes the room for an assessor's expectation to creep in.": "لم يحكم أي إنسان على النتيجة، فلم تستطع معرفة المجموعة أن تلوّنها. وأتمتة القياس تزيل المجال الذي قد يتسلل عبره توقّع المقيّم.",
  "The same 172 patients (86 per arm) had their postoperative complications judged both by an assessor blinded to the fluid regimen and, unblinded, by the local investigators. The intention-to-treat Results print both: unblinded, 27 of 86 (31 percent) on restrictive fluid versus 47 of 86 (55 percent) on standard, P = 0.002; blinded, 28 (33 percent) versus 44 (51 percent), P = 0.013. Every count matches its printed percentage, at 86 patients per arm. Blinding narrows the difference from 24 to 18 percentage points and widens the p-value: it right-sizes a real effect rather than erasing it. The 36 percent figure in the deep-dive is Hrobjartsson 2012, which included this trial among its 21.": "قُيّمت مضاعفات ما بعد الجراحة لدى المرضى الـ172 أنفسهم (86 في كل ذراع) مرتين: مرة بواسطة مقيّم أُعمي عن نظام السوائل، ومرة أخرى، من دون تعمية، بواسطة الباحثين المحليين. وتعرض نتائج التحليل بحسب النية في العلاج كلتا القراءتين: من دون تعمية، 27 من 86 (31%) مع السوائل التقييدية مقابل 47 من 86 (55%) مع المعيارية، P = 0.002؛ وبتعمية، 28 (33%) مقابل 44 (51%)، P = 0.013. وكل عدد يطابق النسبة المئوية المطبوعة له، عند 86 مريضاً في كل ذراع. وتعمية المقيّم تضيّق الفارق من 24 إلى 18 نقطة مئوية وتوسّع قيمة p: فهي تُعيد الأثر الحقيقي إلى حجمه الصحيح لا أنها تمحوه. والرقم 36% الوارد في التوسّع المعمّق مأخوذ من دراسة Hrobjartsson لعام 2012، التي ضمّت هذه التجربة ضمن الـ21 تجربة التي شملتها.",

  // ---- Statistical versus clinical significance puzzle + review items ----
  "A flu drug beats placebo with P < 0.001, from every trial ever run on it. Governments stockpiled billions. Convinced?": "دواء للإنفلونزا يتفوق على الدواء الوهمي بقيمة P < 0.001، في كل تجربة أُجريت عليه على الإطلاق. خزّنت الحكومات منه المليارات. هل اقتنعت؟",
  "Reviewers obtained the full clinical study reports, not just the published papers, and pooled them. Adults given the drug got better sooner than adults given placebo, and the whole confidence interval sits clear of no difference.": "حصل المراجِعون على تقارير الدراسات السريرية الكاملة، لا الأبحاث المنشورة وحدها، وجمعوها معاً. فتحسّن البالغون الذين تلقّوا الدواء أسرع من البالغين الذين تلقّوا الدواء الوهمي، ويقع فاصل الثقة بأكمله بعيداً كل البعد عن انعدام الفرق.",
  "How much should this change what you do?": "كم ينبغي أن يغيّر هذا مما تفعله؟",
  "Time to first relief of flu symptoms, hours saved": "الوقت حتى أول تخفيف لأعراض الإنفلونزا، الساعات الموفَّرة",
  "hours": "ساعات",
  "P < 0.001": "P < 0.001",
  ...
  "It is certainly real. It is also about sixteen hours.": "إنه حقيقي يقيناً. وهو أيضاً نحو ست عشرة ساعة.",
  "Significant answers a different question": "الدلالة الإحصائية تجيب عن سؤال آخر",
  "Flu runs about seven days. The drug takes it to six and a bit: 16.8 hours off 168, which is a tenth of the illness. The reviewers put it plainly, that the drug modestly shortens symptoms, and in the same breath that it causes nausea and vomiting. One extra person vomits for every 22 treated.": "تستمر الإنفلونزا نحو 7 أيام. يخفضها الدواء إلى ستة أيام وبعض اليوم: 16.8 ساعة من أصل 168، أي عُشر مدة المرض. وقد ذكر المراجِعون الأمر بوضوح: إن الدواء يقصّر الأعراض تقصيراً متواضعاً، وفي الوقت نفسه إنه يسبب الغثيان والتقيؤ. فيتقيأ شخص إضافي واحد مقابل كل 22 شخصاً عولجوا.",
  "Nothing was recalculated between these two pictures. The estimate, the interval and the p-value are identical; only what they are measured against changed. A p-value answers whether a difference could plausibly be chance, and with enough patients even a trivial difference cannot be. It never answers whether the difference is worth having. That question needs a size and a yardstick, and the yardstick has to come from outside the statistics.": "لم يُعَد حساب أي شيء بين هاتين الصورتين. فالتقدير والفاصل وقيمة p متطابقة جميعاً؛ ولم يتغيّر سوى ما يُقاس الفرق إزاءه. تجيب قيمة p عن سؤال هل يمكن أن يكون الفرق مجرد صدفة، ومع عدد كافٍ من المرضى، حتى الفرق التافه لا يمكن أن يكون كذلك. لكنها لا تجيب أبداً عن سؤال هل يستحق هذا الفرق أن يُعتد به. وهذا السؤال يحتاج إلى حجم ومقياس مرجعي، وذلك المقياس يجب أن يأتي من خارج الإحصاء.",
  "The same number, other ruler": "الرقم نفسه، مسطرة أخرى",
  "Statistical versus clinical significance": "الدلالة الإحصائية في مقابل الأهمية السريرية",
  "A small p-value means an effect is probably not chance. It says nothing about whether the effect is big enough to care about. Sample size buys certainty, never importance, so always ask for the size of the difference and what would count as a difference worth having.": "قيمة p الصغيرة تعني أن الأثر على الأرجح ليس صدفة. وهي لا تقول شيئاً عمّا إذا كان الأثر كبيراً بما يكفي لكي يُعتد به. فحجم العيّنة يشتري اليقين، لا الأهمية أبداً، لذا اسأل دائماً عن حجم الفرق وعمّا يُعتبر فرقاً يستحق أن يُعتد به.",
  "The two questions get answered by different numbers. Could this be chance is answered by the p-value and the confidence interval. Is this worth having is answered by the effect size, set against something that matters: how long the illness lasts, how bad the symptoms are, what the treatment costs you in side effects. A result can be emphatic on the first and pitiful on the second, and press releases have every incentive to quote only the first.": "يُجاب عن السؤالين بأرقام مختلفة. فسؤال هل يمكن أن يكون هذا صدفة تجيب عنه قيمة p وفاصل الثقة. وسؤال هل يستحق هذا أن يُعتد به يجيب عنه حجم الأثر، موضوعاً في مقابل شيء ذي بال: كم تدوم مدة المرض، وكم تشتد الأعراض سوءاً، وكم يكلّفك العلاج من آثار جانبية. وقد تكون النتيجة قاطعة في الإجابة الأولى ومخيبة في الثانية، ولدى البيانات الصحفية كل الحافز لكي تقتبس الأولى وحدها.",
  "A p-value is a statement about how easily chance could produce the difference you saw, and it depends on the size of the study as much as on the size of the effect. Quadruple the patients and the same trivial difference has a p-value four times more impressive, because the estimate is that much more precisely pinned down. Push the numbers far enough and any difference at all, however meaningless, becomes highly significant. That is not a flaw in the arithmetic, it is what the arithmetic was built to do: separate signal from noise, and nothing more. The consequence is a habit worth keeping for life. When you meet a significant result, do not ask how significant. Ask how big, in units you can picture, and against what. If nobody has told you what size of difference would have been worth the trouble, the significance on its own has not told you anything you can act on.": "قيمة p عبارة عن بيان بمدى سهولة أن تُنتج الصدفة الفرق الذي رأيته، وهي تعتمد على حجم الدراسة بقدر ما تعتمد على حجم الأثر. فإذا ضاعفتَ عدد المرضى أربع مرات، أصبح للفرق التافه نفسه قيمة p أكثر إثارة للإعجاب بأربع مرات، لأن التقدير أصبح مضبوطاً بدقة أكبر من ذلك بكثير. وإذا دفعتَ الأرقام بعيداً بما يكفي، أصبح أي فرق على الإطلاق، مهما كان تافهاً، ذا دلالة إحصائية عالية. وهذا ليس عيباً في الحساب، بل هو بالضبط ما بُني الحساب لكي يفعله: فصل الإشارة عن الضجيج، ولا شيء أكثر من ذلك. والنتيجة عادة تستحق أن تُبقيها طوال العمر. فحين تصادف نتيجة ذات دلالة، لا تسأل عن مدى دلالتها. اسأل عن حجمها، بوحدات يمكنك تخيّلها، وفي مقابل ماذا. فإذا لم يخبرك أحد بحجم الفرق الذي كان سيستحق كل هذا العناء، فإن الدلالة وحدها لم تخبرك بشيء يمكنك أن تتصرف بناءً عليه.",
  "The bar the field set, and the result that missed it": "السقف الذي وضعه الميدان، والنتيجة التي لم تبلغه",
  "A meta-analysis of every antidepressant trial submitted to the American regulator found the drugs beat placebo with high confidence, by 1.80 points on a depression scale. The guideline body's own threshold for a difference that matters clinically was three points, so the authors reported an effect that was statistically certain and below the bar its own field had set. Two questions, two answers, and only one of them was in the headline.": "وجد تحليل تلوي لكل تجربة على مضادات الاكتئاب قُدِّمت إلى الجهة التنظيمية الأمريكية أن الأدوية تتفوق على الدواء الوهمي بثقة عالية، بمقدار 1.80 نقطة على مقياس للاكتئاب. وكان الحد الذي وضعته هيئة الإرشادات نفسها لفرق ذي أهمية سريرية هو 3 نقاط، فأبلغ المؤلفون عن أثر مؤكَّد إحصائياً وواقع دون السقف الذي وضعه ميدانه نفسه. سؤالان، وجوابان، ولم يكن في العنوان الرئيسي سوى أحدهما.",
  "Statistical versus clinical significance, a reasoning trap.": "الدلالة الإحصائية في مقابل الأهمية السريرية، فخ في الاستدلال.",
  "A tiny p-value means a difference is probably not a fluke. It does not mean the difference is big enough to bother with. Study enough people and even a pointless difference becomes highly significant, because certainty is what sample size buys. Before believing a result matters, ask how large it is in units you can picture, and what size would have been worth having.": "قيمة p الضئيلة تعني أن الفرق على الأرجح ليس محض مصادفة. وهي لا تعني أن الفرق كبير بما يكفي لكي يُعنى به المرء. ادرس عدداً كافياً من الناس، وحتى الفرق التافه يصبح ذا دلالة إحصائية عالية، لأن اليقين هو ما يشتريه حجم العيّنة. وقبل أن تصدّق أن نتيجة ما مهمة، اسأل عن حجمها بوحدات يمكنك تخيّلها، وعن الحجم الذي كان سيستحق أن يُطلب.",
  "Everyone reads the p-value. Almost nobody asks how big.": "يقرأ الجميع قيمة p. وقلّما يسأل أحد عن حجم الأثر.",
  "P less than 0.001, I said. It was sixteen hours.": "قلتُ: P أقل من 0.001. وكانت المسألة ست عشرة ساعة.",
  "The BMJ abstract prints the treatment effect in adults as a reduction in time to first alleviation of symptoms of 16.8 hours (95 percent confidence interval 8.4 to 25.1), P < 0.001, and the harms as nausea (risk difference 3.66 percent, number needed to harm 28) and vomiting (4.56 percent, number needed to harm 22). The Cochrane review of the same dataset expresses the same benefit as a fall from 7 days to 6.3 days, which is where the 168-hour illness in the figure comes from; 168 minus 16.8 is 151.2 hours, or 6.3 days, and 16.8 is exactly a tenth of 168. Two honesty notes. The 7-day figure is the review's own description of the untreated illness rather than a separately measured mean with its own interval, so the second panel is drawn to the review's stated baseline. And the reviewers' conclusion is that the drug modestly shortens symptoms while causing nausea and vomiting, not that it does nothing: the lesson here is about the size of a real effect, not about denying it.": "يُثبت ملخص مجلة BMJ أثر العلاج لدى البالغين بوصفه تراجعاً في الوقت حتى أول تخفيف للأعراض قدره 16.8 ساعة (فاصل ثقة 95 بالمئة من 8.4 إلى 25.1)، P < 0.001، ويُثبت الأضرار على هيئة غثيان (فارق مخاطر 3.66 بالمئة، العدد اللازم علاجه لضرر واحد: 28) وتقيؤ (4.56 بالمئة، العدد اللازم علاجه لضرر واحد: 22). وتعبّر مراجعة كوكرين للبيانات نفسها عن الفائدة نفسها بوصفها هبوطاً من 7 أيام إلى 6.3 أيام، ومن هناك جاءت مدة المرض البالغة 168 ساعة في الرسم؛ فـ168 ناقص 16.8 يساوي 151.2 ساعة، أي 6.3 أيام، و16.8 يساوي بالضبط عُشر 168. وهاتان ملاحظتا نزاهة. رقم الأيام السبعة هو وصف المراجعة نفسها للمرض غير المعالَج لا متوسط قِيس على حدة وله فاصله الخاص، ولذلك رُسمت اللوحة الثانية بحسب خط الأساس الذي ذكرته المراجعة. أما خلاصة المراجِعين فهي أن الدواء يقصّر الأعراض تقصيراً متواضعاً بينما يسبب الغثيان والتقيؤ، لا أنه لا يفعل شيئاً: فالدرس هنا يتعلق بحجم أثر حقيقي، لا بإنكاره.",
  "A company tested a redesign on 4 million users and reported that it loaded significantly faster, p < 0.0001. The press release calls it a major speed improvement. The measured difference is 3 milliseconds.": "اختبرت شركة إعادة تصميم على 4 ملايين مستخدم وأبلغت أنه صار يُحمَّل بسرعة أكبر بدلالة إحصائية، p < 0.0001. ويصف البيان الصحفي الأمر بأنه تحسّن كبير في السرعة. والفرق المقيس هو 3 أجزاء من الألف من الثانية.",
  "With 4 million users even a 3 millisecond difference is far too consistent to be chance, so the tiny p-value is guaranteed. Nobody can perceive 3 milliseconds, so the result is certain and worthless.": "مع 4 ملايين مستخدم، حتى فرق 3 أجزاء من الألف من الثانية يكون منتظماً أكثر من أن يُعزى إلى الصدفة، لذا فإن قيمة p الضئيلة مضمونة. ولا يستطيع أحد أن يدرك 3 أجزاء من الألف من الثانية، فالنتيجة مؤكَّدة ولا قيمة لها.",
  "A weight-loss programme trialled in 30,000 people reports that participants lost significantly more than controls, p < 0.001, and markets itself on that result. Over a year the difference averaged 400 grams.": "برنامج لإنقاص الوزن جُرِّب على 30,000 شخص يُبلغ أن المشاركين فقدوا وزناً أكثر بدلالة إحصائية من مجموعة الضبط، p < 0.001، ويُسوَّق لنفسه بهذه النتيجة. وعلى مدى سنة، بلغ متوسط الفرق 400 غرام.",
  "A 400 gram difference over a year is of no health consequence, but with 30,000 people it is measured precisely enough to be highly significant. The p-value confirms the difference is real, not that it is worth the effort.": "فرق 400 غرام على مدى سنة لا يترتب عليه أي أثر صحي، لكن مع 30,000 شخص يُقاس بدقة كافية لكي يكون ذا دلالة إحصائية عالية. تؤكد قيمة p أن الفرق حقيقي، لا أنه يستحق العناء.",
  "A supplement lowered blood pressure by 0.6 mmHg more than placebo in a trial of 50,000 adults, p < 0.001. An advert says it is clinically proven to lower blood pressure, without naming the number.": "خفّض مكمّل غذائي ضغط الدم بمقدار 0.6 mmHg أكثر من الدواء الوهمي في تجربة على 50,000 بالغ، p < 0.001. ويقول إعلان إنه مثبَت سريرياً لخفض ضغط الدم، دون ذكر الرقم.",
  "Guidelines treat blood pressure changes of a few mmHg as the smallest worth acting on, so 0.6 is negligible, but 50,000 people make it statistically certain. The claim leans entirely on significance and hides the size.": "تعامل الإرشادات تغيّرات ضغط الدم البالغة بضعة ملليمترات زئبقية بوصفها أصغر تغيّر يستحق التصرف بناءً عليه، لذا فإن 0.6 لا يُعتد به، لكن 50,000 شخص يجعلونه مؤكَّداً إحصائياً. ويعتمد الادعاء كلياً على الدلالة الإحصائية ويخفي الحجم.",
  "An education study of 100,000 pupils found that an online tutoring add-on raised exam marks by a statistically significant amount, p < 0.001, and a minister cites it as proof the programme works. The gain was 0.3 marks out of 100.": "وجدت دراسة تربوية على 100,000 تلميذ أن إضافة تدريس إلكتروني رفعت درجات الامتحان بمقدار ذي دلالة إحصائية، p < 0.001، ويستشهد بها وزير دليلاً على أن البرنامج ينفع. وكانت الزيادة 0.3 درجة من أصل 100.",
  "A third of a mark out of a hundred changes nothing for any pupil, yet 100,000 of them pin the estimate down tightly enough to be highly significant. Significance is being used as a stand-in for a benefit nobody has shown.": "ثلث درجة من أصل مئة لا يغيّر شيئاً لأي تلميذ، ومع ذلك فإن 100,000 منهم يضبطون التقدير بإحكام يكفي لكي يكون ذا دلالة إحصائية عالية. وتُستخدم الدلالة الإحصائية بديلاً عن فائدة لم يُظهرها أحد.",
  "Researchers report a significant association between a food and a blood marker in 500,000 people, with a vanishingly small p-value. A news story says the food strongly affects the marker. The correlation is 0.01.": "يُبلغ باحثون عن ارتباط ذي دلالة إحصائية بين طعام ما ومؤشر في الدم لدى 500,000 شخص، بقيمة p ضئيلة تكاد تتلاشى. وتقول قصة إخبارية إن الطعام يؤثر بقوة في المؤشر. والارتباط هو 0.01.",
  "A correlation of 0.01 explains essentially none of the variation, but half a million people make even that distinguishable from zero many times over. The extreme p-value reflects the sample size, not the strength of the link.": "ارتباط قدره 0.01 لا يفسّر عملياً أي شيء من التباين، لكن نصف مليون شخص يجعلون حتى هذا القدر متمايزاً عن الصفر مرات ومرات. وتعكس قيمة p الشديدة الصغر حجم العيّنة، لا قوة الصلة.",
  "A mattress company's study of 80,000 sleepers found their model gave significantly more sleep than a standard one, p < 0.001, and the packaging says so. The extra sleep averaged 90 seconds a night.": "وجدت دراسة لشركة مراتب على 80,000 نائم أن طرازها يمنح نوماً أكثر بدلالة إحصائية من طراز عادي، p < 0.001، وتذكر العبوة ذلك. وبلغ متوسط النوم الإضافي 90 ثانية في الليلة.",
  "Ninety seconds is well below any amount a sleeper would notice or benefit from, yet 80,000 people make it a highly significant difference. The claim rests on the p-value and never mentions the size.": "90 ثانية أقل بكثير من أي مقدار قد يلاحظه النائم أو يستفيد منه، ومع ذلك فإن 80,000 شخص يجعلونها فرقاً ذا دلالة إحصائية عالية. ويستند الادعاء إلى قيمة p ولا يذكر الحجم أبداً.",
  "A fuel additive tested across 200,000 journeys significantly improved fuel economy, p < 0.001. The manufacturer advertises proven savings. The improvement was 0.1 percent, and the additive costs more than that.": "إضافة وقود اختُبرت عبر 200,000 رحلة حسّنت اقتصاد الوقود بدلالة إحصائية، p < 0.001. وتعلن الشركة الصانعة عن وفورات مثبَتة. وكان التحسن 0.1 بالمئة، وتكلفة الإضافة أكبر من ذلك.",
  "The improvement is real and precisely measured, which is what the p-value shows, but at 0.1 percent it costs more than it saves. Statistical significance says the effect exists, not that it is worth buying.": "التحسن حقيقي ومقيس بدقة، وهذا ما تُظهره قيمة p، لكن عند 0.1 بالمئة فإنه يكلّف أكثر مما يوفّر. تقول الدلالة الإحصائية إن الأثر موجود، لا إنه يستحق الشراء.",
  "A hospital reports that a new triage system significantly reduced waiting times across 300,000 attendances, p < 0.001, and the board declares the rollout a success. Average waits fell from 247 minutes to 245.": "يُبلغ مستشفى أن نظام فرز جديداً خفّض أوقات الانتظار بدلالة إحصائية عبر 300,000 مراجعة، p < 0.001، ويعلن المجلس أن تعميمه نجاح. وانخفض متوسط الانتظار من 247 دقيقة إلى 245.",
  "Two minutes off a four-hour wait is nothing to a patient, but 300,000 attendances make it statistically unmistakable. The board has read certainty as importance.": "دقيقتان من انتظار أربع ساعات لا تعنيان شيئاً لمريض، لكن 300,000 مراجعة تجعلانه أمراً لا لبس فيه إحصائياً. وقد قرأ المجلس اليقين على أنه أهمية.",
  "A painkiller beat placebo on a 0 to 100 pain scale in 25,000 patients, p < 0.001, and is promoted on that basis. The difference was 1.5 points, and researchers in the field treat about 10 points as the smallest change patients notice.": "تفوّق مسكّن للألم على الدواء الوهمي على مقياس ألم من 0 إلى 100 لدى 25,000 مريض، p < 0.001، ويُروَّج له على هذا الأساس. وكان الفرق 1.5 نقطة، ويعتبر الباحثون في هذا الميدان أن نحو 10 نقاط هو أصغر تغيّر يلاحظه المرضى.",
  "The field already has a yardstick, roughly 10 points, and 1.5 falls far below it. The large trial makes that small difference statistically certain without making it perceptible to anyone.": "لدى هذا الميدان مقياس مرجعي بالفعل، نحو 10 نقاط، ويقع 1.5 دون ذلك بكثير. وتجعل التجربة الكبيرة ذلك الفرق الصغير مؤكَّداً إحصائياً دون أن تجعله محسوساً لأي أحد.",
  "A phone maker tested a software update on 2 million handsets and reported significantly longer battery life, p < 0.0001, headlining the update. Screen-on time rose by 40 seconds.": "اختبرت شركة هواتف تحديثاً برمجياً على 2 مليون جهاز وأبلغت عن عمر بطارية أطول بدلالة إحصائية، p < 0.0001، وتصدّر ذلك عنوان التحديث. وارتفع وقت تشغيل الشاشة بمقدار 40 ثانية.",
  "Forty seconds of screen time is imperceptible over a day, yet two million handsets make the measurement precise enough for an extreme p-value. The headline reports how sure they are, not how much it helps.": "40 ثانية من وقت تشغيل الشاشة لا تُحَس على مدى يوم، ومع ذلك فإن مليوني جهاز يجعلان القياس دقيقاً بما يكفي لقيمة p شديدة الصغر. ويُبلغ العنوان عن مدى تيقّنهم، لا عن مقدار الفائدة.",
  "A trial reports that its drug improved walking distance by 68 metres, states that researchers in the field regard 30 metres as the smallest improvement patients notice, and concludes the benefit is both statistically and clinically meaningful.": "تُبلغ تجربة أن دواءها حسّن مسافة المشي بمقدار 68 مترًا، وتذكر أن الباحثين في هذا الميدان يعتبرون 30 مترًا أصغر تحسّن يلاحظه المرضى، وتخلص إلى أن الفائدة ذات دلالة إحصائية وأهمية سريرية معاً.",
  "The report gives the size of the effect, names an external yardstick, and shows the effect clears it. That is exactly the pair of questions a result should answer, so nothing is being smuggled past the reader.": "يذكر التقرير حجم الأثر، ويسمّي مقياساً مرجعياً خارجياً، ويُظهر أن الأثر يتجاوزه. وهذا بالضبط زوج الأسئلة الذي ينبغي لأي نتيجة أن تجيب عنه، فلا شيء يُهرَّب هنا أمام القارئ.",
  "A very large study finds a statistically significant difference and its authors write that, although the p-value is small, the difference is too slight to change practice, and recommend against acting on it.": "تجد دراسة كبيرة جداً فرقاً ذا دلالة إحصائية، ويكتب مؤلفوها أنه رغم صِغر قيمة p، فإن الفرق أقل من أن يغيّر الممارسة، ويوصون بعدم التصرف بناءً عليه.",
  "The authors separate the two questions properly: the effect is real, and it is not worth acting on. Declining to convert a small p-value into a recommendation is the careful move, not the trap.": "يفصل المؤلفون بين السؤالين على النحو الصحيح: الأثر حقيقي، ولا يستحق التصرف بناءً عليه. والامتناع عن تحويل قيمة p الصغيرة إلى توصية هو الخطوة الحصيفة، لا الفخ.",
  "A small trial finds a promising-looking improvement that does not reach statistical significance, and the authors report the estimate with a wide confidence interval, saying the study cannot rule out either a useful benefit or no benefit at all.": "تجد تجربة صغيرة تحسّناً يبدو واعداً لكنه لا يبلغ الدلالة الإحصائية، ويُبلغ المؤلفون عن التقدير مع فاصل ثقة واسع، قائلين إن الدراسة لا يمكنها أن تستبعد فائدة حقيقية ولا انعدام الفائدة كلياً.",
  ...
  "In 1930, American states with more immigrants had less illiteracy. So immigrants could read better than the locals?": "في عام 1930، كانت الولايات الأمريكية التي بها مهاجرون أكثر تُسجّل أمية أقل. فهل كان المهاجرون يقرأون أفضل من السكان المحليين؟",
  "One census, 48 states. For each state, the share of people born abroad and the share who could not read. The more foreign born a state was, the lower its illiteracy, and the pattern is strong enough that people have been quoting it ever since.": "تعداد واحد، 48 ولاية. لكل ولاية نسبة من وُلدوا خارج البلاد ونسبة من لم يكونوا يستطيعون القراءة. كلما زادت نسبة المولودين خارج البلاد في ولاية ما، انخفضت نسبة الأمية فيها، والنمط قوي إلى درجة أن الناس ما زالوا يستشهدون به منذ ذلك الحين.",
  "What does that tell you about immigrants?": "ماذا يخبرك هذا عن المهاجرين؟",
  "Born abroad and unable to read, 1930 census": "المولودون خارج البلاد وغير القادرين على القراءة، تعداد 1930",
  ...
  "Illiteracy": "الأمية",
  "The slope is drawn from the published correlation. Robinson printed the coefficient, never the figures for each state, so plotting dots here would be inventing them.": "الخط مرسوم اعتماداً على الارتباط المنشور. فقد نشر روبنسون معامل الارتباط فقط، ولم ينشر قط أرقام كل ولاية على حدة، فرسم نقاط هنا كان سيعني اختلاقها.",
  "Counts in thousands of people, from the paper's own table.": "الأعداد بالآلاف من الأشخاص، مأخوذة من جدول البحث نفسه.",
  ...
  "Count people instead of states and it turns the other way.": "عُدّ الأشخاص بدلاً من الولايات، وينقلب الاتجاه.",
  "Places are not people": "الأماكن ليست أشخاصاً",
  "In the same census, 1,304 of every 13,217 people born abroad could not read, against 2,614 of every 84,055 born in the country. That is about 10 per cent against 3, so immigrants were around three times as likely to be illiterate, not less. Across states the correlation is -.53; across people it is +.12.": "في التعداد نفسه، لم يكن 1,304 من كل 13,217 شخصاً وُلدوا خارج البلاد قادرين على القراءة، مقابل 2,614 من كل 84,055 وُلدوا داخل البلاد. أي نحو 10 بالمئة مقابل 3، بحيث كان المهاجرون أكثر عرضة للأمية بنحو ثلاثة أضعاف، لا أقل. الارتباط عبر الولايات هو -.53؛ وعبر الأشخاص هو +.12.",
  "Both numbers are right, and they are answers to different questions. Immigrants settled where the work was, and those states also had the money and the schools that kept everyone else's illiteracy low. So a state's immigrant share tracked its wealth, and its wealth tracked its literacy, while inside every state the immigrants themselves were the ones more likely to be unable to read. Nothing about the state-level line was ever a claim about a person.": "الرقمان كلاهما صحيح، وهما إجابتان عن سؤالين مختلفين. استقر المهاجرون حيث كان العمل متوفراً، وكانت تلك الولايات نفسها تملك المال والمدارس التي أبقت أمية الجميع منخفضة. فنسبة المهاجرين في الولاية كانت تعكس ثراءها، وثراؤها كان يعكس مستوى تعليمها، بينما داخل كل ولاية كان المهاجرون أنفسهم هم الأكثر عرضة لعدم إجادة القراءة. لم يكن الخط على مستوى الولايات قط ادعاءً بشأن شخص بعينه.",
  "Same census, other unit": "التعداد نفسه، وحدة أخرى",
  "The ecological fallacy": "المغالطة البيئية",
  "A relationship measured between groups need not hold, and can run backwards, inside them. If the rows in your table are places, schools or countries, the finding is about places, schools or countries, and carrying it down to a person is a separate claim that needs its own evidence.": "العلاقة المقيسة بين مجموعات لا يلزم أن تصمد، بل يمكن أن تسير بالعكس داخل تلك المجموعات. فإذا كانت صفوف جدولك أماكن أو مدارس أو دولاً، فالنتيجة تخص أماكن أو مدارس أو دولاً، ونقلها إلى مستوى شخص بعينه ادعاء منفصل يحتاج إلى دليله الخاص.",
  "The tell is the unit of analysis: ask what one row of the data actually is. Averages per country, per region, per hospital or per school are convenient because they are published, but a pattern among averages can be produced entirely by which people ended up where. The same trap runs the other way too, so a pattern among individuals need not reappear when they are grouped.": "المؤشر الكاشف هو وحدة التحليل: اسأل عمّا يمثله صف واحد من البيانات فعلياً. المتوسطات لكل دولة أو لكل منطقة أو لكل مستشفى أو لكل مدرسة مريحة لأنها منشورة، لكن النمط بين المتوسطات قد ينتج بالكامل عن مكان استقرار كل شخص. والفخ نفسه يعمل في الاتجاه المعاكس أيضاً، فالنمط بين الأفراد لا يلزم أن يظهر من جديد حين يُجمَّعون في مجموعات.",
  "Picture two states. One is rich, with good schools, and attracts most of the immigrants; almost everyone there can read, immigrants slightly less often than the rest. The other is poor, has few immigrants, and much of its population never finished school. Plot the two states and you get a clean downward line: more immigrants, less illiteracy. Now pool the people and count them one by one, and the immigrants come out worse, because within each state they always were. The state-level line was never measuring immigrants at all. It was measuring the difference between a rich state and a poor one, with the immigrant share acting as a marker for which was which. This is why the fallacy is so easy to commit with published statistics: aggregated tables are what governments release, so the temptation is to answer a question about people using the only data on the shelf.": "تخيّل ولايتين. إحداهما غنية، ومدارسها جيدة، وتجذب معظم المهاجرين؛ يستطيع القراءة فيها كل الناس تقريباً، والمهاجرون أقل قليلاً من الباقين. والأخرى فقيرة، ومهاجروها قليلون، وجزء كبير من سكانها لم يُتمّ تعليمه قط. ارسم الولايتين على مخطط فتحصل على خط نازل واضح: مهاجرون أكثر، أمية أقل. والآن اجمع الأشخاص كلهم وعُدّهم واحداً واحداً، فيظهر المهاجرون في وضع أسوأ، لأنهم داخل كل ولاية كانوا كذلك دائماً. لم يكن الخط على مستوى الولايات يقيس المهاجرين إطلاقاً. كان يقيس الفرق بين ولاية غنية وأخرى فقيرة، مع نسبة المهاجرين تعمل كعلامة تدل على أيّهما كانت أيّهما. ولهذا يسهل الوقوع في هذه المغالطة عند استخدام الإحصاءات المنشورة: الجداول المجمّعة هي ما تنشره الحكومات، فيصبح الإغراء قائماً بالإجابة عن سؤال يخص الأشخاص باستخدام البيانات الوحيدة المتوفرة.",
  "The correction that left the lesson standing": "التصحيح الذي لم يُسقط الدرس",
  "In 2011 a re-analysis found Robinson had used the wrong state-level figures, and that the correlation across states is nearer -0.46 than the -0.53 he printed. The number moved, the reversal did not: across states the relationship still runs one way and across people the other. A textbook case is more useful when its arithmetic has been checked than when it is merely repeated.": "في عام 2011 وجدت إعادة تحليل أن روبنسون استخدم أرقاماً خاطئة على مستوى الولايات، وأن الارتباط بين الولايات أقرب إلى -0.46 منه إلى -0.53 الذي نشره. الرقم تغيّر، أما الانعكاس فلم يتغيّر: العلاقة بين الولايات ما زالت تسير في اتجاه، وبين الأشخاص في الاتجاه المعاكس. والمثال المدرسي يكون أكثر فائدة حين تُراجَع حساباته لا حين يُكتفى بتكراره.",
  "The ecological fallacy, a reasoning trap.": "المغالطة البيئية، فخ في الاستدلال.",
  "A pattern found by comparing places can reverse completely when you count people instead. Areas with more immigrants had less illiteracy, yet immigrants themselves were three times likelier to be unable to read, because they settled where the schools were good. Before believing a statistic about people, check whether the rows in the table were people at all.": "النمط الذي تكتشفه بمقارنة الأماكن يمكن أن ينعكس تماماً حين تعُدّ الأشخاص بدلاً من ذلك. المناطق التي فيها مهاجرون أكثر كانت أمّيتها أقل، ومع ذلك كان المهاجرون أنفسهم أكثر عرضة بثلاثة أضعاف لعدم إجادة القراءة، لأنهم استقروا حيث كانت المدارس جيدة. قبل أن تصدق إحصائية عن الأشخاص، تحقق مما إذا كانت صفوف الجدول تمثل أشخاصاً أصلاً.",
  "Same census, opposite answer. Depends what you count.": "التعداد نفسه، والإجابة معاكسة. الأمر يعتمد على ما تعدّه.",
  "I read a fact about states as a fact about people.": "قرأت حقيقة عن الولايات وكأنها حقيقة عن الأشخاص.",
  "The person-level counts are Robinson's own, in thousands: 1,304 illiterate of 13,217 born abroad and 2,614 of 84,055 born in the country, which give 9.9 per cent against 3.1 and reproduce the +.118 he prints. The outcome is illiteracy, not literacy, which is why the individual figure is positive. Robinson prints -.526 across the 48 states and -.619 across the nine census divisions. Two honesty notes. The state-level figure is authored here as the coefficient rather than as points, because he published the correlation and never the per-state figures, so the setup draws a slope and says so on the figure rather than inventing a scatter. And te Grotenhuis and colleagues showed in 2011 that his state-level data were wrong and the correlation is nearer -0.46; the reversal between the two levels survives the correction, which is the only thing this puzzle claims.": "الأعداد على مستوى الأشخاص هي أعداد روبنسون نفسه، بالآلاف: 1,304 أمّياً من أصل 13,217 مولوداً خارج البلاد، و2,614 من أصل 84,055 مولوداً داخل البلاد، وهو ما يعطي 9.9 بالمئة مقابل 3.1 ويعيد إنتاج القيمة +.118 التي ينشرها. المتغير المقيس هو الأمية لا الإلمام بالقراءة، ولهذا يكون الرقم الفردي موجباً. وينشر روبنسون -.526 عبر 48 ولاية و-.619 عبر تسعة أقسام تعداد. ملاحظتا أمانة. الرقم على مستوى الولايات مؤَلَّف هنا كمعامل ارتباط لا كنقاط، لأنه نشر الارتباط ولم ينشر قط أرقام كل ولاية، فالتصميم يرسم خطاً منحدراً ويوضح ذلك على الرسم بدلاً من اختلاق توزيع نقطي. كما بيّن تي غروتنهاوس وزملاؤه عام 2011 أن بيانات روبنسون على مستوى الولايات كانت خاطئة وأن الارتباط أقرب إلى -0.46؛ والانعكاس بين المستويين يصمد أمام هذا التصحيح، وهذا هو الشيء الوحيد الذي يدّعيه هذا اللغز.",
  "Countries that eat more sugar have higher rates of a disease. A columnist tells readers that eating sugar raises their personal risk, citing the country comparison as the evidence.": "الدول التي يأكل سكانها سكراً أكثر تسجّل معدلات أعلى من أحد الأمراض. ويخبر كاتب عمود قراءه أن تناول السكر يرفع خطرهم الشخصي، مستشهداً بمقارنة الدول كدليل.",
  "The rows in that table are countries, not people. Rich countries differ from poor ones in dozens of ways at once, so the line across them may not hold for any individual. A claim about a person needs data measured on people.": "صفوف ذلك الجدول هي دول، لا أشخاص. تختلف الدول الغنية عن الفقيرة في عشرات الجوانب في آن واحد، فقد لا يصمد الخط الذي يربطها بالنسبة لأي فرد. الادعاء عن شخص بعينه يحتاج إلى بيانات مقيسة على الأشخاص.",
  "Schools with more spending per pupil get better average exam results, so a council concludes that spending more on any given child will raise that child's marks.": "المدارس التي تنفق أكثر على كل تلميذ تحقق متوسط نتائج امتحانات أفضل، فيستنتج مجلس أن زيادة الإنفاق على أي طفل بعينه سترفع درجاته.",
  "The comparison is between schools, and schools differ in intake as well as budget. Well-funded schools often sit in wealthier areas, so the pattern can be about which children attend rather than about what an extra pound does for one of them.": "المقارنة هنا بين مدارس، والمدارس تختلف في نوعية الطلاب المُلتحقين بها كما تختلف في ميزانياتها. غالباً ما تقع المدارس الجيدة التمويل في مناطق أكثر ثراءً، فقد يكون النمط متعلقاً بمن يلتحق بالمدرسة لا بما يفعله جنيه إضافي لأحد التلاميذ.",
  "Richer regions vote for one party more often, so an analyst writes that richer voters back that party. No individual-level survey is cited.": "المناطق الأغنى تصوّت لحزب معيّن بشكل أكثر تكراراً، فيكتب محلل أن الناخبين الأغنى يدعمون ذلك الحزب. ولا يُستشهد بأي استطلاع على المستوى الفردي.",
  "A region's average income and an individual's income are different variables. The regional pattern can run one way while richer individuals inside those regions vote the other way, which is exactly what has been found in some countries.": "متوسط دخل المنطقة ودخل الفرد متغيران مختلفان. يمكن أن يسير النمط الإقليمي في اتجاه بينما يصوّت الأفراد الأغنى داخل تلك المناطق في الاتجاه المعاكس، وهذا بالضبط ما وُجد في بعض الدول.",
  "Hospitals with more nurses per bed have lower average death rates, and a manager concludes that any individual patient given more nursing attention is less likely to die.": "المستشفيات التي فيها ممرضون أكثر لكل سرير تسجّل متوسط معدلات وفاة أقل، فيستنتج مدير أن أي مريض بعينه يحصل على رعاية تمريضية أكبر أقل عرضة للوفاة.",
  "The unit here is the hospital. Better staffed hospitals also tend to be better funded and to treat different case mixes, so the between-hospital pattern is not by itself a statement about what happens to one patient.": "الوحدة هنا هي المستشفى. المستشفيات ذات الطاقم الأكبر تميل أيضاً إلى تمويل أفضل ومعالجة مزيج مختلف من الحالات، فالنمط بين المستشفيات لا يشكّل وحده تصريحاً بما يحدث لمريض واحد.",
  "Towns with cleaner air have longer average life expectancy, so a report states that breathing cleaner air will add years to a reader's life, using only the town-level figures.": "البلدات ذات الهواء الأنظف يكون متوسط العمر المتوقع فيها أطول، فيذكر تقرير أن تنفس هواء أنظف سيضيف سنوات إلى عمر القارئ، معتمداً فقط على أرقام مستوى البلدة.",
  "Towns with clean air differ from others in wealth, occupation and smoking as well. The town-level association can be produced by who lives where, so it cannot on its own quantify what cleaner air does for one person.": "تختلف البلدات ذات الهواء النظيف عن غيرها في الثراء والمهن والتدخين أيضاً. يمكن أن ينتج الارتباط على مستوى البلدة عن مَن يعيش أين، فلا يستطيع وحده أن يقيس ما يفعله هواء أنظف لشخص واحد.",
  "Across 30 countries, average height rises with average dairy consumption, and a magazine advises readers that drinking more milk will make them taller, citing that country chart.": "عبر 30 دولة، يرتفع متوسط الطول مع متوسط استهلاك منتجات الألبان، وتنصح مجلة قراءها بأن شرب المزيد من الحليب سيجعلهم أطول، مستشهدة بذلك الرسم البياني للدول.",
  "Each point is a whole country, so the chart compares national averages shaped by genetics, wealth and childhood nutrition together. Turning it into personal advice treats a fact about countries as a fact about a body.": "كل نقطة تمثل دولة بأكملها، فالرسم يقارن متوسطات وطنية تتشكل بفعل الوراثة والثراء وتغذية الطفولة مجتمعة. وتحويل ذلك إلى نصيحة شخصية يعامل حقيقة عن الدول وكأنها حقيقة عن جسد واحد.",
  "Neighbourhoods with more young men have more recorded crime, and a report concludes that a given young man is more likely to be an offender than a given older resident, using only the neighbourhood totals.": "الأحياء التي فيها شبان أكثر تسجّل جرائم أكثر، ويستنتج تقرير أن شاباً بعينه أكثر عرضة لأن يكون مجرماً من مقيم أكبر سناً بعينه، معتمداً فقط على إجماليات الحي.",
  "The data counts neighbourhoods, so it cannot say who committed the crimes. Areas with young populations also tend to differ in income and housing, and the individual claim needs individual records.": "البيانات تعُدّ الأحياء، فلا يمكنها أن تحدد من ارتكب الجرائم. المناطق ذات السكان الشباب تميل أيضاً إلى الاختلاف في الدخل والسكن، والادعاء الفردي يحتاج إلى سجلات فردية.",
  "Teams with more experienced staff ship fewer bugs on average, so a director tells one junior engineer that their individual bug rate must be the reason their team struggles.": "الفرق التي فيها موظفون أكثر خبرة تُصدر أخطاءً برمجية أقل في المتوسط، فيخبر مدير مهندساً مبتدئاً بعينه أن معدل أخطائه الفردي لا بد أنه سبب معاناة فريقه.",
  "The pattern is measured across teams, which differ in the difficulty of what they build as well as in experience. Nothing in a team-level average identifies which person produced which defect.": "النمط مقيس عبر الفرق، وهي تختلف في صعوبة ما تبنيه كما تختلف في الخبرة. لا شيء في متوسط مستوى الفريق يحدد أي شخص أنتج أي خلل.",
  "Countries with more television sets per household report higher literacy, and an editorial argues that watching television makes an individual more literate.": "الدول التي فيها أجهزة تلفاز أكثر لكل أسرة تسجّل إلماماً بالقراءة أعلى، وتجادل مقالة افتتاحية بأن مشاهدة التلفاز تجعل الفرد أكثر إلماماً بالقراءة.",
  "Television ownership marks how wealthy a country is, and wealth brings schools. The country-level link is about national development, so it licenses no claim about what watching television does to one viewer.": "امتلاك التلفاز مؤشر على ثراء الدولة، والثراء يجلب المدارس. العلاقة على مستوى الدولة تخص التنمية الوطنية، فهي لا تسوّغ أي ادعاء عمّا تفعله مشاهدة التلفاز لمشاهد واحد.",
  "Clinics with longer average waiting times report higher patient satisfaction, and a board concludes that making an individual patient wait longer will make that patient happier.": "العيادات ذات متوسط أوقات الانتظار الأطول تسجّل رضا مرضى أعلى، ويستنتج مجلس إدارة أن جعل مريض بعينه ينتظر مدة أطول سيجعله أسعد.",
  "Comparing clinics is not comparing patients. Busy, popular clinics can have both long queues and good care, so a clinic-level correlation cannot be read as what waiting does to one person, and here it is plainly implausible.": "مقارنة العيادات ليست مقارنة المرضى. يمكن للعيادات المزدحمة والمرغوبة أن تجمع بين طوابير طويلة ورعاية جيدة، فلا يمكن قراءة الارتباط على مستوى العيادة كأنه ما يفعله الانتظار لشخص واحد، وهذا هنا غير معقول بوضوح.",
  "Researchers wanted to know whether a diet affects one person's risk, so rather than comparing country averages they followed 40,000 individuals, recording each person's own diet and their own outcome, and reported the association among those people.": "أراد باحثون معرفة ما إذا كان نظام غذائي يؤثر في خطر شخص واحد، فبدلاً من مقارنة متوسطات الدول تابعوا 40,000 فرد، وسجّلوا نظام كل شخص الغذائي الخاص ونتيجته الخاصة، وأبلغوا عن العلاقة بين هؤلاء الأشخاص.",
  "The question was about individuals and the data was measured on individuals, so the unit of analysis matches the claim. That is precisely the step the ecological fallacy skips.": "كان السؤال عن الأفراد وكانت البيانات مقيسة على الأفراد، فوحدة التحليل تطابق الادعاء. وهذه بالضبط هي الخطوة التي تتجاوزها المغالطة البيئية.",
  "A study finds that countries with stricter seatbelt laws have fewer road deaths per head, and concludes that such laws are associated with lower national death rates, explicitly declining to say what any individual driver's risk would be.": "تجد دراسة أن الدول ذات قوانين حزام الأمان الأكثر صرامة تسجّل وفيات طرق أقل لكل فرد، وتستنتج أن هذه القوانين مرتبطة بمعدلات وفاة وطنية أقل، وترفض صراحة أن تذكر ما سيكون عليه خطر أي سائق بعينه.",
  "The data is national and the conclusion is kept national. Policy questions are legitimately asked at the level of populations, and the authors do not smuggle the finding down to a person.": "البيانات وطنية والاستنتاج يبقى وطنياً. أسئلة السياسات تُطرح بشكل مشروع على مستوى السكان، ولا يُهرّب المؤلفون النتيجة إلى مستوى شخص بعينه.",
  "Analysts studying whether neighbourhood poverty affects individual health use records that hold both each person's own income and their neighbourhood's, and report the neighbourhood effect after accounting for the person's own circumstances.": "يستخدم محللون يدرسون ما إذا كان فقر الحي يؤثر في صحة الفرد سجلات تضم دخل كل شخص الخاص ودخل حيه معاً، ويبلّغون عن أثر الحي بعد ضبط ظروف الشخص الخاصة.",
  "Holding both levels in the same model is the standard way to separate what an area does from what a person's own situation does, so the group-level claim is not resting on individual-level guesswork.": "إدراج المستويين معاً في النموذج نفسه هو الطريقة المعتادة للفصل بين ما تفعله المنطقة وما يفعله وضع الشخص الخاص، بحيث لا يستند الادعاء على مستوى المجموعة إلى تخمين على المستوى الفردي.",
