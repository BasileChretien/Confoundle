...
import { WEAPON_COLOR, drawFrame, type Pulse } from "./render";
...
function paint(canvas: HTMLCanvasElement, view: RunView, pulses: readonly Pulse[]): void {
  ...
  drawFrame(ctx, { view, pulses, width: w, height: h });
}
